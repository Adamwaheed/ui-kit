<template>
    <div>
        <ul v-if="files && files.length > 0" role="list" class="po-divide-y po-divide-gray-200 po-rounded-md po-border po-border-gray-200 po-mt-5">
            <li
                v-for="file in files"
            ...
            >
                ...
                <PaperClipIcon class="po-h-5 po-w-5 po-flex-shrink-0 po-text-gray-400" aria-hidden="true" />
                <span class="po-ml-2 po-w-0 po-flex-1 po-truncate">{{ file.label }}</span>
                </div>
