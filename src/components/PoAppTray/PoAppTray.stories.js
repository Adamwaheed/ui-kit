...
export default {
	...
	parameters: {
		docs: {
			...
			description: {
				component:
					"This component lives inside PoTopBar component. You can populate it by passing data through PoTopBar component from the main App view.",
			},
		},
		backgrounds: {
			default: "mpao",
...
const Template = (args) => ({
	...
	template:
		'<div class="po-relative po-flex po-items-center po-space-x-3 po-w-full po-justify-end"><PoAppTray v-bind="args" /></div>',
});
