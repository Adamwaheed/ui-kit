<template>
  <div class="po-py-3 po-px-5 po-border-b po-border-slate-200">
    <form class="po-flex po-w-full md:po-ml-0" action="#" method="GET">
      ...
      <div
        class="
          po-relative po-w-full po-text-slate-400
          focus-within:po-text-mpao-lightblue
          po-transition-colors po-duration-100 po-ease-in-out
        "
      >
        <div
          class="
        ...
        <input
          ...
          class="
            ...
            po-text-sm
            po-text-slate-700
            po-placeholder-slate-500
            focus:po-border-transparent
            focus:po-placeholder-slate-400
