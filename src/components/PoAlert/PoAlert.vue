	...
	<TransitionRoot as="template" :show="isShowing">
		<Dialog as="div" class="po-relative po-z-50" @close="closeModal">
			...
			<div class="po-fixed po-inset-0 po-z-10 po-overflow-y-auto">
				<div
					class="po-flex po-min-h-full po-items-start po-justify-center po-p-4 po-text-center sm:po-p-0"
				>
					<TransitionChild
						as="template"
						enter="po-ease-out po-duration-300"
					...
					>
						<DialogPanel
							class="po-relative po-transform po-overflow-hidden po-rounded-lg po-bg-white po-text-left po-shadow-xl po-transition-all sm:po-my-8 sm:po-w-full sm:po-max-w-sm"
						>
							<div class="po-p-5">
