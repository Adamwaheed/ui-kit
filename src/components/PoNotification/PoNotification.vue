        ...
        <div class="po-p-4">
          <div class="po-flex po-items-start">
            ...
            <div class="po-ml-3 po-w-0 po-flex-1 po-pt-0.5">
              <p class="po-text-sm po-font-medium po-text-sky-100">
                {{ label }}
              </p>
              ...
              <div class="po-mt-3 po-flex po-space-x-4">
                <!--
                    ...
                    -->
                <button
                  @click="$emit('button-click', buttonLabel)"
                  type="button"
                  class="
                    po-rounded-md
                    po-bg-mpao-lightblue
                    ...
                    po-font-medium
                    po-text-sky-100
                    hover:po-text-sky-200
                    focus:po-outline-none
                    focus:po-ring-2
                    focus:po-ring-sky-200
