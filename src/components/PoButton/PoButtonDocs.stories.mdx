...
<Source
  ...
  format={true}
  code={dedent`
    <PoButton type="button" label="Button" @button-click="handleButtonClick" />
    <PoButton type="submit" label="Submit" />
    <PoButton type="link" label="Link" to="/home" />
    <PoButton type="simple" label="I am a button" to="/home" @button-click="handleButtonClick" />
...
<Source
  ...
  format={true}
  code={dedent`
    <PoButton @button-click="handleButtonClick">
    ...
    <PoButton @button-click="handleButtonClick" type="link" to="/home">
      <template v-slot:label>
    ...
    <PoButton @button-click="handleButtonClick" type="simple" to="/home">
      <template v-slot:label>
        <span class="po-flex po-items-center po-space-x-1">
          <BoltIcon class="po-w-4 po-h-4 po-stroke-current" />
          <span>File a dispute.</span>
