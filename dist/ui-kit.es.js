...
const s1 = /* @__PURE__ */ Uo(bu, [["render", yu]]), xu = {
  name: "AnimatedLogo"
...
const ku = /* @__PURE__ */ Uo(xu, [["render", $u]]), _u = {
  key: 0,
...
const Ke = Symbol(process.env.NODE_ENV !== "production" ? "openBlock" : ""), Cc = Symbol(process.env.NODE_ENV !== "production" ? "createBlock" : ""), Sc = Symbol(process.env.NODE_ENV !== "production" ? "createElementBlock" : ""), Ec = Symbol(process.env.NODE_ENV !== "production" ? "createVNode" : ""), Oc = Symbol(process.env.NODE_ENV !== "production" ? "createElementVNode" : ""), Go = Symbol(process.env.NODE_ENV !== "production" ? "createCommentVNode" : "");
...
const Dc = Symbol(process.env.NODE_ENV !== "production" ? "normalizeProps" : ""), Ko = Symbol(process.env.NODE_ENV !== "production" ? "guardReactiveProps" : ""), Tc = Symbol(process.env.NODE_ENV !== "production" ? "toHandlers" : "");
...
const Uc = /* @__PURE__ */ new Set([Dc, Ko]);
function Jo(e, t = []) {
  if (e && !ye(e) && e.type === 14) {
    const n = e.callee;
    if (!ye(n) && Uc.has(n))
...
Xo(/^(if|else|else-if)$/, (e, t, n) => Qc(e, t, n, (o, l, a) => {
