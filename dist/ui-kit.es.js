import { openBlock as r, createElementBlock as u, createElementVNode as s, ref as V, toRefs as ye, watch as q, Fragment as B, createVNode as C, unref as h, withCtx as T, renderSlot as te, createBlock as M, resolveDynamicComponent as be, createCommentVNode as b, computed as S, toDisplayString as m, withDirectives as Ge, isRef as Go, withKeys as Zo, vModelText as gt, cloneVNode as Ko, h as J, inject as se, provide as ie, onMounted as U, watchEffect as ne, defineComponent as W, toRaw as K, onUnmounted as ue, nextTick as Ve, Teleport as Ze, reactive as Qo, shallowRef as to, normalizeClass as E, renderList as R, Transition as $e, withModifiers as re, onBeforeMount as Yo, onBeforeUpdate as Jo, onUpdated as yt, mergeProps as Ee, createTextVNode as X, normalizeProps as Me, guardReactiveProps as Ie, normalizeStyle as xt, vModelCheckbox as Xo, onBeforeUnmount as wt, createStaticVNode as el } from "vue";
import { f as zt, a as tl } from "./FormatMoney-edf23aad.mjs";
function ol(e, t) {
  return r(), u("svg", {
...
const yl = /* @__PURE__ */ s("div", {
...
], -1), xl = { class: "po-bg-mpao-blue po-fixed po-top-0 po-w-full po-z-50 po-flex" }, wl = { class: "po-shrink-0 po-px-3 po-pt-3" }, Vl = {
  for: "sidebar-drawer-toggle",
  role: "button",
  class: "genie-effect po-flex po-items-center po-justify-center po-bg-[#2e5266] po-rounded-full po-w-10 po-h-10 po-select-none po-text-slate-100"
}, kl = { class: "po-mx-auto po-max-w-full po-pr-4 po-grow sm:po-pr-4" }, $l = { class: "po-flex po-relative po-h-16 po-items-center po-justify-between po-space-x-12" }, _l = { class: "po-flex po-items-center po-space-x-3" }, Cl = {
  key: 0,
  class: "po-block po-w-6 po-text-slate-100 md:po-hidden",
  role: "button"
}, Sl = {
  name: "PoTopBar"
}, S1 = /* @__PURE__ */ Object.assign(Sl, {
  props: {
    /**
     * Search Query
     */
  ...
  setup(e, { emit: t }) {
    const l = e, n = V(""), o = V(""), { avatar: a, logo: i } = ye(l);
    q(a, () => {
      n.value = a.value;
    }), q(i, () => {
      o.value = i.value;
    ...
    return (v, d) => (r(), u(B, null, [
      yl,
      s("nav", xl, [
        s("div", wl, [
          s("label", Vl, [
            C(h(al), { class: "po-w-6 po-fill-current" })
          ])
        ]),
        s("div", kl, [
          s("div", $l, [
            C(h(jl), { "app-name": e.appName }, {
              icon: T(() => [
                te(v.$slots, "appIcon", {}, () => [
                  e.appIcon ? (r(), M(be(e.appIcon), { key: 0 })) : b("", !0)
                ])
              ]),
              _: 3
            }, 8, ["app-name"]),
            e.hasSearch ? (r(), M(h(Il), {
              key: 0,
              onQuery: c,
              onOnClear: f,
            ...
            s("div", _l, [
              e.hasSearch ? (r(), u("span", Cl, [
                C(h(Vt), { class: "po-stroke-current" })
              ])) : b("", !0),
              C(h(ba), {
...
}), Pl = { class: "po-flex po-items-center po-justify-center po-space-x-3" }, Ol = { class: "po-w-8 po-text-slate-100 app-icon" }, El = { class: "po-font-light po-text-lg po-text-slate-100" }, Ll = { class: "po-hidden md:po-block" }, Tl = { class: "po-block md:po-hidden" }, Bl = {
  name: "PoAppIcon"
  ...
  setup(e, { emit: t }) {
    ...
    return q(l, async (o, a) => {
      o === "" && t("onClear", !0);
    }), (o, a) => (r(), u("div", Dl, [
      Ge(s("input", {
        "onUpdate:modelValue": a[0] || (a[0] = (i) => Go(l) ? l.value = i : l = i),
        type: "text",
        id: "main-search",
      ...
      s("div", Al, [
        C(h(Vt), { class: "po-w-5 po-h-5 po-stroke-current" })
      ])
    ]));
  }
});
...
var de = ((e) => (e[e.None = 0] = "None", e[e.RenderStrategy = 1] = "RenderStrategy", e[e.Static = 2] = "Static", e))(de || {}), ke = ((e) => (e[e.Unmount = 0] = "Unmount", e[e.Hidden = 1] = "Hidden", e))(ke || {});
function G({ visible: e = !0, features: t = 0, ourProps: l, theirProps: n, ...o }) {
  var a;
  let i = no(n, l), p = Object.assign(o, { props: i });
  if (e || t & 2 && i.static)
    return rt(p);
  if (t & 1) {
...
function rt({ props: e, attrs: t, slots: l, slot: n, name: o }) {
  var a, i;
  let { as: p, ...c } = je(e, ["unmount", "static"]), f = (a = l.default) == null ? void 0 : a.call(l, n), v = {};
  if (n) {
    let d = !1, g = [];
    for (let [w, k] of Object.entries(n))
      typeof k == "boolean" && (d = !0), k === !0 && g.push(w);
    d && (v["data-headlessui-state"] = g.join(" "));
  }
  if (p === "template") {
    if (f = lo(f ?? []), Object.keys(c).length > 0 || Object.keys(t).length > 0) {
      let [d, ...g] = f ?? [];
      if (!Rl(d) || g.length > 0)
        throw new Error(['Passing props on "template"!', "", `The current component <${o} /> is rendering a "template".`, "However we need to passthrough the following props:", Object.keys(c).concat(Object.keys(t)).map((x) => x.trim()).filter((x, y, $) => $.indexOf(x) === y).sort((x, y) => x.localeCompare(y)).map((x) => `  - ${x}`).join(`
`), "", "You can apply a few solutions:", ['Add an `as="..."` prop, to ensure that we render an actual element instead of a "template".', "Render a single element as the child so that we can forward the props onto that element."].map((x) => `  - ${x}`).join(`
`)].join(`
`));
      let w = no((i = d.props) != null ? i : {}, c), k = Ko(d, w);
      for (let x in w)
  ...
  return J(p, Object.assign({}, c, v), { default: () => f });
}
function lo(e) {
  return e.flatMap((t) => t.type === B ? lo(t.children) : [t]);
}
function no(...e) {
  if (e.length === 0)
    return {};
...
function Ye(e, t) {
  let l = V(qt(e.value.type, e.value.as));
  return U(() => {
...
var Wl = Object.defineProperty, Gl = (e, t, l) => t in e ? Wl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: l }) : e[t] = l, Ut = (e, t, l) => (Gl(e, typeof t != "symbol" ? t + "" : t, l), l);
let Zl = class {
  constructor() {
...
var ae = ((e) => (e[e.First = 1] = "First", e[e.Previous = 2] = "Previous", e[e.Next = 4] = "Next", e[e.Last = 8] = "Last", e[e.WrapAround = 16] = "WrapAround", e[e.NoScroll = 32] = "NoScroll", e))(ae || {}), Te = ((e) => (e[e.Error = 0] = "Error", e[e.Overflow = 1] = "Overflow", e[e.Success = 2] = "Success", e[e.Underflow = 3] = "Underflow", e))(Te || {}), Kl = ((e) => (e[e.Previous = -1] = "Previous", e[e.Next = 1] = "Next", e))(Kl || {});
...
function Yl(e) {
  var t, l;
  return (l = (t = e == null ? void 0 : e.matches) == null ? void 0 : t.call(e, Ql)) != null ? l : !1;
}
function _t(e, t = (l) => l) {
...
function ve(e, t, { sorted: l = !0, relativeTo: n = null, skipElements: o = [] } = {}) {
  var a;
  let i = (a = Array.isArray(e) ? e.length > 0 ? e[0].ownerDocument : document : e == null ? void 0 : e.ownerDocument) != null ? a : document, p = Array.isArray(e) ? l ? _t(e) : e : Je(e);
  o.length > 0 && p.length > 1 && (p = p.filter((k) => !o.includes(k))), n = n ?? i.activeElement;
  let c = (() => {
    if (t & 5)
      return 1;
    if (t & 10)
    ...
    if (t & 8)
      return p.length - 1;
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), v = t & 32 ? { preventScroll: !0 } : {}, d = 0, g = p.length, w;
  do {
    if (d >= g || d + g <= 0)
      return 0;
    let k = f + d;
    ...
    w = p[k], w == null || w.focus(v), d += c;
  } while (w !== i.activeElement);
  return t & 6 && Yl(w) && w.select(), w.hasAttribute("tabindex") || w.setAttribute("tabindex", "0"), 2;
}
function it(e, t, l) {
  Re.isServer || ne((n) => {
...
function Ct(e, t, l = S(() => !0)) {
  function n(a, i) {
    ...
    return !ro(p, $t.Loose) && p.tabIndex !== -1 && a.preventDefault(), t(a, p);
  }
  let o = V(null);
  it("mousedown", (a) => {
    var i, p;
...
var on = ((e) => (e[e.Open = 0] = "Open", e[e.Closed = 1] = "Closed", e))(on || {}), ln = ((e) => (e[e.Single = 0] = "Single", e[e.Multi = 1] = "Multi", e))(ln || {}), nn = ((e) => (e[e.Pointer = 0] = "Pointer", e[e.Other = 1] = "Other", e))(nn || {});
let fo = Symbol("ComboboxContext");
function De(e) {
  let t = se(fo, null);
  if (t === null) {
...
let an = W({ name: "Combobox", emits: { "update:modelValue": (e) => !0 }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: !1 }, by: { type: [String, Function], default: () => tn }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, name: { type: String }, nullable: { type: Boolean, default: !1 }, multiple: { type: [Boolean], default: !1 } }, inheritAttrs: !1, setup(e, { slots: t, attrs: l, emit: n }) {
  let o = V(1), a = V(null), i = V(null), p = V(null), c = V(null), f = V({ static: !1, hold: !1 }), v = V([]), d = V(null), g = V(1), w = V(!1);
  function k(L = (A) => A) {
    let A = d.value !== null ? v.value[d.value] : null, N = _t(L(v.value.slice()), (F) => P(F.dataRef.domRef)), j = A ? N.indexOf(A) : null;
    return j === -1 && (j = null), { options: N, activeOptionIndex: j };
  }
  let x = S(() => e.multiple ? 1 : 0), y = S(() => e.nullable), [$, _] = Pt(S(() => e.modelValue === void 0 ? Q(x.value, { [1]: [], [0]: void 0 }) : e.modelValue), (L) => n("update:modelValue", L), S(() => e.defaultValue)), O = { comboboxState: o, value: $, mode: x, compare(L, A) {
    if (typeof e.by == "string") {
      let N = e.by;
      return (L == null ? void 0 : L[N]) === (A == null ? void 0 : A[N]);
    }
    return e.by(L, A);
  }, defaultValue: S(() => e.defaultValue), nullable: y, inputRef: i, labelRef: a, buttonRef: p, optionsRef: c, disabled: S(() => e.disabled), options: v, change(L) {
    _(L);
  }, activeOptionIndex: S(() => {
    if (w.value && d.value === null && v.value.length > 0) {
      let L = v.value.findIndex((A) => !A.dataRef.disabled);
      if (L !== -1)
        return L;
    }
    return d.value;
  }), activationTrigger: g, optionsPropsRef: f, closeCombobox() {
    w.value = !1, !e.disabled && o.value !== 1 && (o.value = 1, d.value = null);
  }, openCombobox() {
    if (w.value = !0, e.disabled || o.value === 0)
      return;
    let L = v.value.findIndex((A) => {
      let N = K(A.dataRef.value);
      return Q(x.value, { [0]: () => O.compare(K(O.value.value), K(N)), [1]: () => K(O.value.value).some((j) => O.compare(K(j), K(N))) });
    });
    L !== -1 && (d.value = L), o.value = 0;
  }, goToOption(L, A, N) {
    if (w.value = !1, e.disabled || c.value && !f.value.static && o.value === 1)
      return;
    let j = k();
    if (j.activeOptionIndex === null) {
      let ee = j.options.findIndex((ge) => !ge.dataRef.disabled);
      ee !== -1 && (j.activeOptionIndex = ee);
    }
    let F = ql(L === ce.Specific ? { focus: ce.Specific, id: A } : { focus: L }, { resolveItems: () => j.options, resolveActiveIndex: () => j.activeOptionIndex, resolveId: (ee) => ee.id, resolveDisabled: (ee) => ee.dataRef.disabled });
    d.value = F, g.value = N ?? 1, v.value = j.options;
  }, selectOption(L) {
    let A = v.value.find((j) => j.id === L);
    if (!A)
      return;
    let { dataRef: N } = A;
    _(Q(x.value, { [0]: () => N.value, [1]: () => {
      let j = K(O.value.value).slice(), F = K(N.value), ee = j.findIndex((ge) => O.compare(F, K(ge)));
      return ee === -1 ? j.push(F) : j.splice(ee, 1), j;
    } }));
  }, selectActiveOption() {
    if (O.activeOptionIndex.value === null)
      return;
    let { dataRef: L, id: A } = v.value[O.activeOptionIndex.value];
    _(Q(x.value, { [0]: () => L.value, [1]: () => {
      let N = K(O.value.value).slice(), j = K(L.value), F = N.findIndex((ee) => O.compare(j, K(ee)));
      return F === -1 ? N.push(j) : N.splice(F, 1), N;
    } })), O.goToOption(ce.Specific, A);
  }, registerOption(L, A) {
    let N = { id: L, dataRef: A }, j = k((F) => [...F, N]);
    if (d.value === null) {
      let F = A.value.value;
      Q(x.value, { [0]: () => O.compare(K(O.value.value), K(F)), [1]: () => K(O.value.value).some((ee) => O.compare(K(ee), K(F))) }) && (j.activeOptionIndex = j.options.indexOf(N));
    }
    v.value = j.options, d.value = j.activeOptionIndex, g.value = 1;
  }, unregisterOption(L) {
    var A;
    O.activeOptionIndex.value !== null && ((A = O.options.value[O.activeOptionIndex.value]) == null ? void 0 : A.id) === L && (w.value = !0);
    let N = k((j) => {
      let F = j.findIndex((ee) => ee.id === L);
      return F !== -1 && j.splice(F, 1), j;
    });
    v.value = N.options, d.value = N.activeOptionIndex, g.value = 1;
  } };
  Ct([i, p, c], () => O.closeCombobox(), S(() => o.value === 0)), ie(fo, O), Qe(S(() => Q(o.value, { [0]: Y.Open, [1]: Y.Closed })));
  let D = S(() => O.activeOptionIndex.value === null ? null : v.value[O.activeOptionIndex.value].dataRef.value), I = S(() => {
    var L;
  ...
  return U(() => {
    q([I], () => {
      ...
      return I.value.addEventListener("reset", L), () => {
        var A;
        (A = I.value) == null || A.removeEventListener("reset", L);
      };
    }, { immediate: !0 });
  }), () => {
    let { name: L, disabled: A, ...N } = e, j = { open: o.value === 0, disabled: A, activeIndex: O.activeOptionIndex.value, activeOption: D.value, value: $.value };
    return J(B, [...L != null && $.value != null ? St({ [L]: $.value }).map(([F, ee]) => J(we, kt({ features: xe.Hidden, key: F, as: "input", type: "hidden", hidden: !0, readOnly: !0, name: F, value: ee }))) : [], G({ theirProps: { ...l, ...je(N, ["modelValue", "defaultValue", "nullable", "multiple", "onUpdate:modelValue", "by"]) }, ourProps: {}, slot: j, slots: t, attrs: l, name: "Combobox" })]);
  };
} }), sn = W({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: () => `headlessui-combobox-label-${oe()}` } }, setup(e, { attrs: t, slots: l }) {
...
} }), rn = W({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: () => `headlessui-combobox-button-${oe()}` } }, setup(e, { attrs: t, slots: l, expose: n }) {
  ...
  return () => {
    var c, f;
    let v = { open: o.comboboxState.value === 0, disabled: o.disabled.value, value: o.value.value }, { id: d, ...g } = e, w = { ref: o.buttonRef, id: d, type: p.value, tabindex: "-1", "aria-haspopup": "listbox", "aria-controls": (c = P(o.optionsRef)) == null ? void 0 : c.id, "aria-expanded": o.disabled.value ? void 0 : o.comboboxState.value === 0, "aria-labelledby": o.labelRef.value ? [(f = P(o.labelRef)) == null ? void 0 : f.id, d].join(" ") : void 0, disabled: o.disabled.value === !0 ? !0 : void 0, onKeydown: i, onClick: a };
    return G({ ourProps: w, theirProps: g, slot: v, attrs: t, slots: l, name: "ComboboxButton" });
  };
} }), un = W({ name: "ComboboxInput", props: { as: { type: [Object, String], default: "input" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 }, displayValue: { type: Function }, defaultValue: { type: String, default: void 0 }, id: { type: String, default: () => `headlessui-combobox-input-${oe()}` } }, emits: { change: (e) => !0 }, setup(e, { emit: t, attrs: l, slots: n, expose: o }) {
  let a = De("ComboboxInput"), i = { value: !1 };
  o({ el: a.inputRef, $el: a.inputRef });
  let p = S(() => {
    var x;
    let y = a.value.value;
    return P(a.inputRef) ? typeof e.displayValue < "u" && y !== void 0 ? (x = e.displayValue(y)) != null ? x : "" : typeof y == "string" ? y : "" : "";
  });
  U(() => {
    q([p, a.comboboxState], ([x, y], [$, _]) => {
      if (i.value)
        return;
      let O = P(a.inputRef);
      O && (_ === 0 && y === 1 || x !== $) && (O.value = x);
    }, { immediate: !0 }), q([a.comboboxState], ([x], [y]) => {
      if (x === 0 && y === 1) {
        let $ = P(a.inputRef);
        if (!$)
          return;
        let _ = $.value, { selectionStart: O, selectionEnd: D, selectionDirection: I } = $;
        $.value = "", $.value = _, I !== null ? $.setSelectionRange(O, D, I) : $.setSelectionRange(O, D);
      }
    });
  });
  let c = V(!1);
    ...
    switch (i.value = !0, x.key) {
      ...
      case z.Enter:
        if (i.value = !1, a.comboboxState.value !== 0 || c.value)
          return;
        if (x.preventDefault(), x.stopPropagation(), a.activeOptionIndex.value === null) {
          a.closeCombobox();
          return;
        }
        ...
        break;
      case z.ArrowDown:
        return i.value = !1, x.preventDefault(), x.stopPropagation(), Q(a.comboboxState.value, { [0]: () => a.goToOption(ce.Next), [1]: () => a.openCombobox() });
      case z.ArrowUp:
        return i.value = !1, x.preventDefault(), x.stopPropagation(), Q(a.comboboxState.value, { [0]: () => a.goToOption(ce.Previous), [1]: () => {
          a.openCombobox(), Ve(() => {
      ...
      case z.Home:
        if (x.shiftKey)
          break;
        return i.value = !1, x.preventDefault(), x.stopPropagation(), a.goToOption(ce.First);
      case z.PageUp:
        return i.value = !1, x.preventDefault(), x.stopPropagation(), a.goToOption(ce.First);
      case z.End:
        if (x.shiftKey)
          break;
        return i.value = !1, x.preventDefault(), x.stopPropagation(), a.goToOption(ce.Last);
      case z.PageDown:
        return i.value = !1, x.preventDefault(), x.stopPropagation(), a.goToOption(ce.Last);
      case z.Escape:
        if (i.value = !1, a.comboboxState.value !== 0)
          return;
        x.preventDefault(), a.optionsRef.value && !a.optionsPropsRef.value.static && x.stopPropagation(), a.closeCombobox();
        break;
      case z.Tab:
        if (i.value = !1, a.comboboxState.value !== 0)
          return;
  ...
  let k = S(() => {
    var x, y, $, _;
    return (_ = ($ = (y = e.defaultValue) != null ? y : a.defaultValue.value !== void 0 ? (x = e.displayValue) == null ? void 0 : x.call(e, a.defaultValue.value) : null) != null ? $ : a.defaultValue.value) != null ? _ : "";
  });
  return () => {
    var x, y, $, _, O, D;
    let I = { open: a.comboboxState.value === 0 }, { id: L, displayValue: A, onChange: N, ...j } = e, F = { "aria-controls": (x = a.optionsRef.value) == null ? void 0 : x.id, "aria-expanded": a.disabled.value ? void 0 : a.comboboxState.value === 0, "aria-activedescendant": a.activeOptionIndex.value === null || (y = a.options.value[a.activeOptionIndex.value]) == null ? void 0 : y.id, "aria-labelledby": (O = ($ = P(a.labelRef)) == null ? void 0 : $.id) != null ? O : (_ = P(a.buttonRef)) == null ? void 0 : _.id, "aria-autocomplete": "list", id: L, onCompositionstart: f, onCompositionend: v, onKeydown: d, onInput: g, onBlur: w, role: "combobox", type: (D = l.type) != null ? D : "text", tabIndex: 0, ref: a.inputRef, defaultValue: k.value };
    return G({ ourProps: F, theirProps: j, slot: I, attrs: l, slots: n, features: de.RenderStrategy | de.Static, name: "ComboboxInput" });
  };
} }), pn = W({ name: "ComboboxOptions", props: { as: { type: [Object, String], default: "ul" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 }, hold: { type: [Boolean], default: !1 } }, setup(e, { attrs: t, slots: l, expose: n }) {
  let o = De("ComboboxOptions"), a = `headlessui-combobox-options-${oe()}`;
  ...
  return so({ container: S(() => P(o.optionsRef)), enabled: S(() => o.comboboxState.value === 0), accept(c) {
    ...
    var c, f, v;
    let d = { open: o.comboboxState.value === 0 }, g = { "aria-labelledby": (v = (c = P(o.labelRef)) == null ? void 0 : c.id) != null ? v : (f = P(o.buttonRef)) == null ? void 0 : f.id, id: a, ref: o.optionsRef, role: "listbox", "aria-multiselectable": o.mode.value === 1 ? !0 : void 0 }, w = je(e, ["hold"]);
    return G({ ourProps: g, theirProps: w, slot: d, attrs: t, slots: l, features: de.RenderStrategy | de.Static, visible: p.value, name: "ComboboxOptions" });
  };
} }), cn = W({ name: "ComboboxOption", props: { as: { type: [Object, String], default: "li" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: !1 } }, setup(e, { slots: t, attrs: l, expose: n }) {
  let o = De("ComboboxOption"), a = `headlessui-combobox-option-${oe()}`, i = V(null);
  n({ el: i, $el: i });
  let p = S(() => o.activeOptionIndex.value !== null ? o.options.value[o.activeOptionIndex.value].id === a : !1), c = S(() => Q(o.mode.value, { [0]: () => o.compare(K(o.value.value), K(e.value)), [1]: () => K(o.value.value).some((y) => o.compare(K(y), K(e.value))) })), f = S(() => ({ disabled: e.disabled, value: e.value, domRef: i }));
  U(() => o.registerOption(a, f)), ue(() => o.unregisterOption(a)), ne(() => {
    o.comboboxState.value === 0 && p.value && o.activationTrigger.value !== 0 && Ve(() => {
      var y, $;
      return ($ = (y = P(i)) == null ? void 0 : y.scrollIntoView) == null ? void 0 : $.call(y, { block: "nearest" });
    });
  });
  function v(y) {
    if (e.disabled)
      return y.preventDefault();
    o.selectOption(a), o.mode.value === 0 && o.closeCombobox(), en() || requestAnimationFrame(() => {
      var $;
  ...
  function k(y) {
    g.wasMoved(y) && (e.disabled || p.value || o.goToOption(ce.Specific, a, 0));
  }
  function x(y) {
    g.wasMoved(y) && (e.disabled || p.value && (o.optionsPropsRef.value.hold || o.goToOption(ce.Nothing)));
  }
  return () => {
    let { disabled: y } = e, $ = { active: p.value, selected: c.value, disabled: y }, _ = { id: a, ref: i, role: "option", tabIndex: y === !0 ? void 0 : -1, "aria-disabled": y === !0 ? !0 : void 0, "aria-selected": c.value, disabled: void 0, onClick: v, onFocus: d, onPointerenter: w, onMouseenter: w, onPointermove: k, onMousemove: k, onPointerleave: x, onMouseleave: x };
    return G({ ourProps: _, theirProps: e, slot: $, attrs: l, slots: t, name: "ComboboxOption" });
  };
} });
function dn(e, t, l) {
  Re.isServer || ne((n) => {
...
let Ne = Object.assign(W({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: V(/* @__PURE__ */ new Set()) } }, inheritAttrs: !1, setup(e, { attrs: t, slots: l, expose: n }) {
  let o = V(null);
  n({ el: o, $el: o });
  let a = S(() => he(o)), i = V(!1);
  U(() => i.value = !0), ue(() => i.value = !1), vn({ ownerDocument: a }, S(() => i.value && Boolean(e.features & 16)));
  let p = mn({ ownerDocument: a, container: o, initialFocus: S(() => e.initialFocus) }, S(() => i.value && Boolean(e.features & 2)));
  hn({ ownerDocument: a, container: o, containers: e.containers, previousActiveElement: p }, S(() => i.value && Boolean(e.features & 8)));
  let c = Ot();
  function f(w) {
    let k = P(o);
    k && ((x) => x())(() => {
  ...
  function g(w) {
    if (!i.value)
      return;
    let k = mo(e.containers);
    P(o) instanceof HTMLElement && k.add(P(o));
    let x = w.relatedTarget;
    x instanceof HTMLElement && x.dataset.headlessuiFocusGuard !== "true" && (bo(k, x) || (v.value ? ve(P(o), Q(c.value, { [me.Forwards]: () => ae.Next, [me.Backwards]: () => ae.Previous }) | ae.WrapAround, { relativeTo: w.target }) : w.target instanceof HTMLElement && Le(w.target)));
  }
  return () => {
    let w = {}, k = { ref: o, onKeydown: d, onFocusout: g }, { features: x, initialFocus: y, containers: $, ..._ } = e;
    return J(B, [Boolean(x & 4) && J(we, { as: "button", type: "button", "data-headlessui-focus-guard": !0, onFocus: f, features: xe.Focusable }), G({ ourProps: k, theirProps: { ...t, ..._ }, slot: w, attrs: t, slots: l, name: "FocusTrap" }), Boolean(x & 4) && J(we, { as: "button", type: "button", "data-headlessui-focus-guard": !0, onFocus: f, features: xe.Focusable })]);
  };
} }), { features: ho }), Pe = [];
...
function mn({ ownerDocument: e, container: t, initialFocus: l }, n) {
  let o = V(null), a = V(!1);
  return U(() => a.value = !0), ue(() => a.value = !1), U(() => {
    q([t, l, n], (i, p) => {
      if (i.every((f, v) => (p == null ? void 0 : p[v]) === f) || !n.value)
        return;
      let c = P(t);
      c && vo(() => {
        var f, v;
...
function hn({ ownerDocument: e, container: t, containers: l, previousActiveElement: n }, o) {
  ...
  Et((a = e.value) == null ? void 0 : a.defaultView, "focus", (i) => {
    ...
    if (!c)
      return;
    let f = i.target;
    f && f instanceof HTMLElement ? bo(p, f) ? (n.value = f, Le(f)) : (i.preventDefault(), i.stopPropagation(), Le(c)) : Le(n.value);
  }, !0);
}
function bo(e, t) {
  for (let l of e)
...
let yo = W({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: t, attrs: l }) {
  let n = V(null), o = S(() => he(n)), a = bn(), i = se(xo, null), p = V(a === !0 || i == null ? gn(n.value) : i.resolveTarget());
  return ne(() => {
...
} }), xo = Symbol("PortalGroupContext"), yn = W({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(e, { attrs: t, slots: l }) {
...
function wn({ type: e, enabled: t, element: l, onUpdate: n }) {
  let o = xn();
  function a(...i) {
    n == null || n(...i), o(...i);
  }
...
function Xe({ slot: e = V({}), name: t = "Description", props: l = {} } = {}) {
  ...
  return ie(Vo, { register: o, slot: e, name: t, props: l }), S(() => n.value.length > 0 ? n.value.join(" ") : void 0);
}
let kn = W({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: () => `headlessui-description-${oe()}` } }, setup(e, { attrs: t, slots: l }) {
  let n = Vn();
  return U(() => ue(n.register(e.id))), () => {
    let { name: o = "Description", slot: a = V({}), props: i = {} } = n, { id: p, ...c } = e, f = { ...Object.entries(i).reduce((v, [d, g]) => Object.assign(v, { [d]: h(g) }), {}), id: p };
    return G({ ourProps: f, theirProps: c, slot: a.value, attrs: t, slots: l, name: o });
  };
} });
function $n(e) {
  let t = to(e.getSnapshot());
...
let Oe = _n(() => /* @__PURE__ */ new Map(), { PUSH(e, t) {
  ...
  let n = { doc: e, d: t, meta: On(l) }, o = [Sn(), Cn(), Pn()];
...
let Ue = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", tt = W({ name: "Dialog", inheritAttrs: !1, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 }, open: { type: [Boolean, String], default: Ue }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${oe()}` } }, emits: { close: (e) => !0 }, setup(e, { emit: t, attrs: l, slots: n, expose: o }) {
  ...
  let p = V(0), c = Be(), f = S(() => e.open === Ue && c !== null ? (c.value & Y.Open) === Y.Open : e.open), v = V(null), d = V(null), g = S(() => he(v));
  if (o({ el: v, $el: v }), !(e.open !== Ue || c !== null))
  ...
  let w = S(() => i.value && f.value ? 0 : 1), k = S(() => w.value === 0), x = S(() => p.value > 1), y = se(ht, null) !== null, $ = S(() => x.value ? "parent" : "leaf"), _ = S(() => c !== null ? (c.value & Y.Closing) === Y.Closing : !1), O = S(() => y || _.value ? !1 : k.value), D = S(() => {
    var H, Z, le;
    return (le = Array.from((Z = (H = g.value) == null ? void 0 : H.querySelectorAll("body > *")) != null ? Z : []).find((pe) => pe.id === "headlessui-portal-root" ? !1 : pe.contains(P(d)) && pe instanceof HTMLElement)) != null ? le : null;
  });
  Gt(D, O);
  let I = S(() => x.value ? !0 : k.value), L = S(() => {
    var H, Z, le;
    return (le = Array.from((Z = (H = g.value) == null ? void 0 : H.querySelectorAll("[data-headlessui-portal]")) != null ? Z : []).find((pe) => pe.contains(P(d)) && pe instanceof HTMLElement)) != null ? le : null;
  });
  Gt(L, I), wn({ type: "Dialog", enabled: S(() => w.value === 0), element: v, onUpdate: (H, Z) => {
    if (Z === "Dialog")
      return Q(H, { [mt.Add]: () => p.value += 1, [mt.Remove]: () => p.value -= 1 });
  } });
  let A = Xe({ name: "DialogDescription", slot: S(() => ({ open: f.value })) }), N = V(null), j = { titleId: N, panelRef: V(null), dialogState: w, setTitleId(H) {
    N.value !== H && (N.value = H);
  }, close() {
    t("close", !1);
  } };
  ...
  function F() {
    var H, Z, le;
    return [...Array.from((Z = (H = g.value) == null ? void 0 : H.querySelectorAll("html > *, body > *, [data-headlessui-portal]")) != null ? Z : []).filter((pe) => !(pe === document.body || pe === document.head || !(pe instanceof HTMLElement) || pe.contains(P(d)) || j.panelRef.value && pe.contains(j.panelRef.value))), (le = j.panelRef.value) != null ? le : v.value];
  }
  let ee = S(() => !(!k.value || x.value));
  Ct(() => F(), (H, Z) => {
    j.close(), Ve(() => Z == null ? void 0 : Z.focus());
  }, ee);
  let ge = S(() => !(x.value || w.value !== 0));
  Et((a = g.value) == null ? void 0 : a.defaultView, "keydown", (H) => {
    ge.value && (H.defaultPrevented || H.key === z.Escape && (H.preventDefault(), H.stopPropagation(), j.close()));
  });
  let fe = S(() => !(_.value || w.value !== 0 || y));
  return En(g, fe, (H) => {
    var Z;
    return { containers: [...(Z = H.containers) != null ? Z : [], F] };
  }), ne((H) => {
    if (w.value !== 0)
      return;
    let Z = P(v);
    ...
    le.observe(Z), H(() => le.disconnect());
  }), () => {
    let { id: H, open: Z, initialFocus: le, ...pe } = e, qe = { ...l, ref: v, id: H, role: "dialog", "aria-modal": w.value === 0 ? !0 : void 0, "aria-labelledby": N.value, "aria-describedby": A.value }, Ce = { open: w.value === 0 };
    return J(vt, { force: !0 }, () => [J(yo, () => J(yn, { target: v.value }, () => J(vt, { force: !1 }, () => J(Ne, { initialFocus: le, containers: F, features: k.value ? Q($.value, { parent: Ne.features.RestoreFocus, leaf: Ne.features.All & ~Ne.features.FocusLock }) : Ne.features.None }, () => G({ ourProps: qe, theirProps: pe, slot: Ce, attrs: l, slots: n, visible: w.value === 0, features: de.RenderStrategy | de.Static, name: "Dialog" }))))), J(we, { features: xe.Hidden, ref: d })]);
  };
} });
...
W({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-backdrop-${oe()}` } }, inheritAttrs: !1, setup(e, { attrs: t, slots: l, expose: n }) {
  let o = Fe("DialogBackdrop"), a = V(null);
  return n({ el: a, $el: a }), U(() => {
    if (o.panelRef.value === null)
      throw new Error("A <DialogBackdrop /> component is being used, but a <DialogPanel /> component is missing.");
  }), () => {
    let { id: i, ...p } = e, c = { id: i, ref: a, "aria-hidden": !0 };
    return J(vt, { force: !0 }, () => J(yo, () => G({ ourProps: c, theirProps: { ...t, ...p }, slot: { open: o.dialogState.value === 0 }, attrs: t, slots: l, name: "DialogBackdrop" })));
  };
} });
...
} }), ko = W({ name: "DialogTitle", props: { as: { type: [Object, String], default: "h2" }, id: { type: String, default: () => `headlessui-dialog-title-${oe()}` } }, setup(e, { attrs: t, slots: l }) {
...
let $o = Symbol("DisclosureContext");
function Lt(e) {
  let t = se($o, null);
  if (t === null) {
...
let Zt = W({ name: "Disclosure", props: { as: { type: [Object, String], default: "template" }, defaultOpen: { type: [Boolean], default: !1 } }, setup(e, { slots: t, attrs: l }) {
  let n = V(e.defaultOpen ? 0 : 1), o = V(null), a = V(null), i = { buttonId: V(null), panelId: V(null), disclosureState: n, panel: o, button: a, toggleDisclosure() {
  ...
  return ie($o, i), Qe(S(() => Q(n.value, { [0]: Y.Open, [1]: Y.Closed }))), () => {
  ...
  let a = Bn(), i = S(() => a === null ? !1 : a.value === o.panelId.value), p = V(null);
    ...
    if (!e.disabled)
      if (i.value)
        switch (g.key) {
          case z.Space:
          case z.Enter:
            g.preventDefault(), g.stopPropagation(), o.toggleDisclosure(), (w = P(o.button)) == null || w.focus();
            break;
        }
      else
        switch (g.key) {
  ...
  return () => {
    let g = { open: o.disclosureState.value === 0 }, { id: w, ...k } = e, x = i.value ? { ref: p, type: c.value, onClick: f, onKeydown: v } : { id: w, ref: p, type: c.value, "aria-expanded": e.disabled ? void 0 : o.disclosureState.value === 0, "aria-controls": P(o.panel) ? o.panelId.value : void 0, disabled: e.disabled ? !0 : void 0, onClick: f, onKeydown: v, onKeyup: d };
    return G({ ourProps: x, theirProps: k, slot: g, attrs: t, slots: l, name: "DisclosureButton" });
  };
  ...
  return () => {
    let p = { open: o.disclosureState.value === 0, close: o.close }, { id: c, ...f } = e, v = { id: c, ref: o.panel };
    return G({ ourProps: v, theirProps: f, slot: p, attrs: t, slots: l, features: de.RenderStrategy | de.Static, visible: i.value, name: "DisclosurePanel" });
  };
} });
var jn = ((e) => (e[e.Open = 0] = "Open", e[e.Closed = 1] = "Closed", e))(jn || {});
let Co = Symbol("PopoverContext");
function lt(e) {
  let t = se(Co, null);
  if (t === null) {
...
let So = Symbol("PopoverGroupContext");
function Po() {
  return se(So, null);
}
...
let nt = W({ name: "Popover", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: t, attrs: l, expose: n }) {
  ...
  let a = V(null);
  n({ el: a, $el: a });
  let i = V(1), p = V(null), c = V(null), f = V(null), v = V(null), d = S(() => he(a)), g = S(() => {
    var _, O;
    if (!P(p) || !P(v))
      return !1;
    for (let F of document.querySelectorAll("body > *"))
      if (Number(F == null ? void 0 : F.contains(P(p))) ^ Number(F == null ? void 0 : F.contains(P(v))))
        return !0;
    let D = Je(), I = D.indexOf(P(p)), L = (I + D.length - 1) % D.length, A = (I + 1) % D.length, N = D[L], j = D[A];
    return !((_ = P(v)) != null && _.contains(N)) && !((O = P(v)) != null && O.contains(j));
  }), w = { popoverState: i, buttonId: V(null), panelId: V(null), panel: v, button: p, isPortalled: g, beforePanelSentinel: c, afterPanelSentinel: f, togglePopover() {
    i.value = Q(i.value, { [0]: 1, [1]: 0 });
  }, closePopover() {
    i.value !== 1 && (i.value = 1);
  }, close(_) {
    w.closePopover();
    let O = (() => _ ? _ instanceof HTMLElement ? _ : _.value instanceof HTMLElement ? P(_) : P(w.button) : P(w.button))();
    O == null || O.focus();
  } };
  ie(Co, w), Qe(S(() => Q(i.value, { [0]: Y.Open, [1]: Y.Closed })));
  let k = { buttonId: w.buttonId, panelId: w.panelId, close() {
    w.closePopover();
  } }, x = Po(), y = x == null ? void 0 : x.registerPopover;
  function $() {
    var _, O, D, I;
    return (I = x == null ? void 0 : x.isFocusWithinPopoverGroup()) != null ? I : ((_ = d.value) == null ? void 0 : _.activeElement) && (((O = P(p)) == null ? void 0 : O.contains(d.value.activeElement)) || ((D = P(v)) == null ? void 0 : D.contains(d.value.activeElement)));
  }
  return ne(() => y == null ? void 0 : y(k)), Et((o = d.value) == null ? void 0 : o.defaultView, "focus", (_) => {
    var O, D;
    i.value === 0 && ($() || p && v && _.target !== window && ((O = P(w.beforePanelSentinel)) != null && O.contains(_.target) || (D = P(w.afterPanelSentinel)) != null && D.contains(_.target) || w.closePopover()));
  }, !0), Ct([p, v], (_, O) => {
    var D;
    w.closePopover(), ro(O, $t.Loose) || (_.preventDefault(), (D = P(p)) == null || D.focus());
  }, S(() => i.value === 0)), () => {
  ...
  let o = lt("PopoverButton"), a = S(() => he(o.button));
  n({ el: o.button, $el: o.button }), U(() => {
    o.buttonId.value = e.id;
  }), ue(() => {
    o.buttonId.value = null;
  });
  let i = Po(), p = i == null ? void 0 : i.closeOthers, c = Dn(), f = S(() => c === null ? !1 : c.value === o.panelId.value), v = V(null), d = `headlessui-focus-sentinel-${oe()}`;
  f.value || ne(() => {
  ...
  function x($) {
    var _, O;
    e.disabled || (f.value ? (o.closePopover(), (_ = P(o.button)) == null || _.focus()) : ($.preventDefault(), $.stopPropagation(), o.popoverState.value === 1 && (p == null || p(o.buttonId.value)), o.togglePopover(), (O = P(o.button)) == null || O.focus()));
  }
  function y($) {
    $.preventDefault(), $.stopPropagation();
  }
  return () => {
    let $ = o.popoverState.value === 0, _ = { open: $ }, { id: O, ...D } = e, I = f.value ? { ref: v, type: g.value, onKeydown: w, onClick: x } : { ref: v, id: O, type: g.value, "aria-expanded": e.disabled ? void 0 : o.popoverState.value === 0, "aria-controls": P(o.panel) ? o.panelId.value : void 0, disabled: e.disabled ? !0 : void 0, onKeydown: w, onKeyup: k, onClick: x, onMousedown: y }, L = Ot();
    function A() {
      let N = P(o.panel);
      if (!N)
        return;
      function j() {
        Q(L.value, { [me.Forwards]: () => ve(N, ae.First), [me.Backwards]: () => ve(N, ae.Last) }) === Te.Error && ve(Je().filter((F) => F.dataset.headlessuiFocusGuard !== "true"), Q(L.value, { [me.Forwards]: ae.Next, [me.Backwards]: ae.Previous }), { relativeTo: P(o.button) });
      }
      j();
    }
    return J(B, [G({ ourProps: I, theirProps: { ...t, ...D }, slot: _, attrs: t, slots: l, name: "PopoverButton" }), $ && !f.value && o.isPortalled.value && J(we, { id: d, features: xe.Focusable, "data-headlessui-focus-guard": !0, as: "button", type: "button", onFocus: A })]);
  };
} });
W({ name: "PopoverOverlay", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 } }, setup(e, { attrs: t, slots: l }) {
  ...
  return () => {
    ...
    return G({ ourProps: { id: o, "aria-hidden": !0, onClick: p }, theirProps: e, slot: c, attrs: t, slots: l, features: de.RenderStrategy | de.Static, visible: i.value, name: "PopoverOverlay" });
  };
} });
let Bt = W({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 }, focus: { type: Boolean, default: !1 }, id: { type: String, default: () => `headlessui-popover-panel-${oe()}` } }, inheritAttrs: !1, setup(e, { attrs: t, slots: l, expose: n }) {
  let { focus: o } = e, a = lt("PopoverPanel"), i = S(() => he(a.panel)), p = `headlessui-focus-sentinel-before-${oe()}`, c = `headlessui-focus-sentinel-after-${oe()}`;
  n({ el: a.panel, $el: a.panel }), U(() => {
    ...
    ($ = P(a.panel)) != null && $.contains(_) || ve(P(a.panel), ae.First);
  });
  let f = Be(), v = S(() => f !== null ? (f.value & Y.Open) === Y.Open : a.popoverState.value === 0);
  function d(y) {
    var $, _;
    switch (y.key) {
      case z.Escape:
        if (a.popoverState.value !== 0 || !P(a.panel) || i.value && !(($ = P(a.panel)) != null && $.contains(i.value.activeElement)))
          return;
        y.preventDefault(), y.stopPropagation(), a.closePopover(), (_ = P(a.button)) == null || _.focus();
        break;
    }
  }
  function g(y) {
    ...
    L && P(a.panel) && (($ = P(a.panel)) != null && $.contains(L) || (a.closePopover(), ((O = (_ = P(a.beforePanelSentinel)) == null ? void 0 : _.contains) != null && O.call(_, L) || (I = (D = P(a.afterPanelSentinel)) == null ? void 0 : D.contains) != null && I.call(D, L)) && L.focus({ preventScroll: !0 })));
  }
  let w = Ot();
  function k() {
    let y = P(a.panel);
    ...
    function $() {
      Q(w.value, { [me.Forwards]: () => {
        var _;
        ve(y, ae.First) === Te.Error && ((_ = P(a.afterPanelSentinel)) == null || _.focus());
      }, [me.Backwards]: () => {
        var _;
        (_ = P(a.button)) == null || _.focus({ preventScroll: !0 });
      } });
    }
    $();
  }
  function x() {
    ...
    function $() {
      Q(w.value, { [me.Forwards]: () => {
        let _ = P(a.button), O = P(a.panel);
        if (!_)
          return;
        let D = Je(), I = D.indexOf(_), L = D.slice(0, I + 1), A = [...D.slice(I + 1), ...L];
        for (let N of A.slice())
          if (N.dataset.headlessuiFocusGuard === "true" || O != null && O.contains(N)) {
            let j = A.indexOf(N);
            j !== -1 && A.splice(j, 1);
          }
        ve(A, ae.First, { sorted: !1 });
      }, [me.Backwards]: () => {
        var _;
        ve(y, ae.Previous) === Te.Error && ((_ = P(a.button)) == null || _.focus());
      } });
    }
    $();
  }
  return () => {
    let y = { open: a.popoverState.value === 0, close: a.close }, { id: $, focus: _, ...O } = e, D = { ref: a.panel, id: $, onKeydown: d, onFocusout: o && a.popoverState.value === 0 ? g : void 0, tabIndex: -1 };
    return G({ ourProps: D, theirProps: { ...t, ...O }, attrs: t, slot: y, slots: { ...l, default: (...I) => {
      var L;
      return [J(B, [v.value && a.isPortalled.value && J(we, { id: p, ref: a.beforePanelSentinel, features: xe.Focusable, "data-headlessui-focus-guard": !0, as: "button", type: "button", onFocus: k }), (L = l.default) == null ? void 0 : L.call(l, ...I), v.value && a.isPortalled.value && J(we, { id: c, ref: a.afterPanelSentinel, features: xe.Focusable, "data-headlessui-focus-guard": !0, as: "button", type: "button", onFocus: x })])];
...
W({ name: "PopoverGroup", props: { as: { type: [Object, String], default: "div" } }, setup(e, { attrs: t, slots: l, expose: n }) {
  let o = V(null), a = to([]), i = S(() => he(o));
  n({ el: o, $el: o });
  function p(d) {
    let g = a.value.indexOf(d);
    g !== -1 && a.value.splice(g, 1);
  }
  function c(d) {
    return a.value.push(d), () => {
      p(d);
    };
  }
  function f() {
    ...
    return (d = P(o)) != null && d.contains(w) ? !0 : a.value.some((k) => {
      var x, y;
      return ((x = g.getElementById(k.buttonId.value)) == null ? void 0 : x.contains(w)) || ((y = g.getElementById(k.panelId.value)) == null ? void 0 : y.contains(w));
    });
  }
  function v(d) {
  ...
  return ie(So, { registerPopover: c, unregisterPopover: p, isFocusWithinPopoverGroup: f, closeOthers: v }), () => G({ ourProps: { ref: o }, theirProps: e, slot: {}, attrs: t, slots: l, name: "PopoverGroup" });
} });
...
function jt({ slot: e = {}, name: t = "Label", props: l = {} } = {}) {
  ...
  return ie(Eo, { register: o, slot: e, name: t, props: l }), S(() => n.value.length > 0 ? n.value.join(" ") : void 0);
}
let To = W({ name: "Label", props: { as: { type: [Object, String], default: "label" }, passive: { type: [Boolean], default: !1 }, id: { type: String, default: () => `headlessui-label-${oe()}` } }, setup(e, { slots: t, attrs: l }) {
  let n = Lo();
  return U(() => ue(n.register(e.id))), () => {
    let { name: o = "Label", slot: a = {}, props: i = {} } = n, { id: p, passive: c, ...f } = e, v = { ...Object.entries(i).reduce((d, [g, w]) => Object.assign(d, { [g]: h(w) }), {}), id: p };
    return c && (delete v.onClick, delete v.htmlFor, delete f.onClick), G({ ourProps: v, theirProps: f, slot: a, attrs: l, slots: t, name: o });
  };
} });
function Nn(e, t) {
  return e === t;
}
let Bo = Symbol("RadioGroupContext");
function jo(e) {
  let t = se(Bo, null);
  if (t === null) {
...
let An = W({ name: "RadioGroup", emits: { "update:modelValue": (e) => !0 }, props: { as: { type: [Object, String], default: "div" }, disabled: { type: [Boolean], default: !1 }, by: { type: [String, Function], default: () => Nn }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, name: { type: String, optional: !0 }, id: { type: String, default: () => `headlessui-radiogroup-${oe()}` } }, inheritAttrs: !1, setup(e, { emit: t, attrs: l, slots: n, expose: o }) {
  let a = V(null), i = V([]), p = jt({ name: "RadioGroupLabel" }), c = Xe({ name: "RadioGroupDescription" });
  o({ el: a, $el: a });
  let [f, v] = Pt(S(() => e.modelValue), (k) => t("update:modelValue", k), S(() => e.defaultValue)), d = { options: i, value: f, disabled: S(() => e.disabled), firstOption: S(() => i.value.find((k) => !k.propsRef.disabled)), containsCheckedOption: S(() => i.value.some((k) => d.compare(K(k.propsRef.value), K(e.modelValue)))), compare(k, x) {
    if (typeof e.by == "string") {
      let y = e.by;
      return (k == null ? void 0 : k[y]) === (x == null ? void 0 : x[y]);
    }
    return e.by(k, x);
  }, change(k) {
    var x;
    if (e.disabled || d.compare(K(f.value), K(k)))
      return !1;
    let y = (x = i.value.find(($) => d.compare(K($.propsRef.value), K(k)))) == null ? void 0 : x.propsRef;
    return y != null && y.disabled ? !1 : (v(k), !0);
  }, registerOption(k) {
    i.value.push(k), i.value = _t(i.value, (x) => x.element);
  }, unregisterOption(k) {
    let x = i.value.findIndex((y) => y.id === k);
    x !== -1 && i.value.splice(x, 1);
  } };
  ie(Bo, d), so({ container: S(() => P(a)), accept(k) {
  ...
  function g(k) {
    if (!a.value || !a.value.contains(k.target))
      return;
    let x = i.value.filter((y) => y.propsRef.disabled === !1).map((y) => y.element);
    switch (k.key) {
      case z.Enter:
        po(k.currentTarget);
        break;
      ...
      case z.ArrowUp:
        if (k.preventDefault(), k.stopPropagation(), ve(x, ae.Previous | ae.WrapAround) === Te.Success) {
          let y = i.value.find(($) => {
            var _;
            return $.element === ((_ = he(a)) == null ? void 0 : _.activeElement);
          });
  ...
  let w = S(() => {
    var k;
    return (k = P(a)) == null ? void 0 : k.closest("form");
  });
  return U(() => {
    q([w], () => {
    ...
    let { disabled: k, name: x, id: y, ...$ } = e, _ = { ref: a, id: y, role: "radiogroup", "aria-labelledby": p.value, "aria-describedby": c.value, onKeydown: g };
    return J(B, [...x != null && f.value != null ? St({ [x]: f.value }).map(([O, D]) => J(we, kt({ features: xe.Hidden, key: O, as: "input", type: "hidden", hidden: !0, readOnly: !0, name: O, value: D }))) : [], G({ ourProps: _, theirProps: { ...l, ...je($, ["modelValue", "defaultValue"]) }, slot: {}, attrs: l, slots: n, name: "RadioGroup" })]);
  };
} });
var Mn = ((e) => (e[e.Empty = 1] = "Empty", e[e.Active = 2] = "Active", e))(Mn || {});
let In = W({ name: "RadioGroupOption", props: { as: { type: [Object, String], default: "div" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: !1 }, id: { type: String, default: () => `headlessui-radiogroup-option-${oe()}` } }, setup(e, { attrs: t, slots: l, expose: n }) {
  let o = jo("RadioGroupOption"), a = jt({ name: "RadioGroupLabel" }), i = Xe({ name: "RadioGroupDescription" }), p = V(null), c = S(() => ({ value: e.value, disabled: e.disabled })), f = V(1);
  n({ el: p, $el: p }), U(() => o.registerOption({ id: e.id, element: p, propsRef: c })), ue(() => o.unregisterOption(e.id));
  let v = S(() => {
    var $;
    return (($ = o.firstOption.value) == null ? void 0 : $.id) === e.id;
  }), d = S(() => o.disabled.value || e.disabled), g = S(() => o.compare(K(o.value.value), K(e.value))), w = S(() => d.value ? -1 : g.value || !o.containsCheckedOption.value && v.value ? 0 : -1);
  function k() {
    var $;
  ...
  return () => {
    let { id: $, value: _, disabled: O, ...D } = e, I = { checked: g.value, disabled: d.value, active: Boolean(f.value & 2) }, L = { id: $, ref: p, role: "radio", "aria-checked": g.value ? "true" : "false", "aria-labelledby": a.value, "aria-describedby": i.value, "aria-disabled": d.value ? !0 : void 0, tabIndex: w.value, onClick: d.value ? void 0 : k, onFocus: d.value ? void 0 : x, onBlur: d.value ? void 0 : y };
    return G({ ourProps: L, theirProps: D, slot: I, attrs: t, slots: l, name: "RadioGroupOption" });
  };
} }), Yt = To, Rn = kn, Do = Symbol("GroupContext"), Fn = W({ name: "SwitchGroup", props: { as: { type: [Object, String], default: "template" } }, setup(e, { slots: t, attrs: l }) {
  ...
  return ie(Do, { switchRef: n, labelledby: o, describedby: a }), () => G({ theirProps: e, ourProps: {}, slot: {}, slots: t, attrs: l, name: "SwitchGroup" });
} }), zn = W({ name: "Switch", emits: { "update:modelValue": (e) => !0 }, props: { as: { type: [Object, String], default: "button" }, modelValue: { type: Boolean, default: void 0 }, defaultChecked: { type: Boolean, optional: !0 }, name: { type: String, optional: !0 }, value: { type: String, optional: !0 }, id: { type: String, default: () => `headlessui-switch-${oe()}` } }, inheritAttrs: !1, setup(e, { emit: t, attrs: l, slots: n, expose: o }) {
  let a = se(Do, null), [i, p] = Pt(S(() => e.modelValue), (y) => t("update:modelValue", y), S(() => e.defaultChecked));
  function c() {
    p(!i.value);
  }
  let f = V(null), v = a === null ? f : a.switchRef, d = Ye(S(() => ({ as: e.as, type: l.type })), v);
  o({ el: v, $el: v });
  function g(y) {
    y.preventDefault(), c();
  }
  function w(y) {
    y.key === z.Space ? (y.preventDefault(), c()) : y.key === z.Enter && po(y.currentTarget);
  }
  function k(y) {
    y.preventDefault();
  }
  ...
  return U(() => {
    q([x], () => {
      ...
      return x.value.addEventListener("reset", y), () => {
        var $;
        ($ = x.value) == null || $.removeEventListener("reset", y);
      };
    }, { immediate: !0 });
  }), () => {
    let { id: y, name: $, value: _, ...O } = e, D = { checked: i.value }, I = { id: y, ref: v, role: "switch", type: d.value, tabIndex: 0, "aria-checked": i.value, "aria-labelledby": a == null ? void 0 : a.labelledby.value, "aria-describedby": a == null ? void 0 : a.describedby.value, onClick: g, onKeyup: w, onKeypress: k };
    return J(B, [$ != null && i.value != null ? J(we, kt({ features: xe.Hidden, as: "input", type: "checkbox", hidden: !0, readOnly: !0, checked: i.value, name: $, value: _ })) : null, G({ ourProps: I, theirProps: { ...l, ...je(O, ["modelValue", "defaultChecked"]) }, slot: D, attrs: l, slots: n, name: "Switch" })]);
  };
} }), Hn = To;
function qn(e) {
  let t = { called: !1 };
...
function Un(e, t) {
  ...
  let { transitionDuration: n, transitionDelay: o } = getComputedStyle(e), [a, i] = [n, o].map((p) => {
    let [c = 0] = p.split(",").filter(Boolean).map((f) => f.includes("ms") ? parseFloat(f) : parseFloat(f) * 1e3).sort((f, v) => v - f);
    return c;
  });
  return a !== 0 ? l.setTimeout(() => t("finished"), a + i) : t("finished"), l.add(() => t("cancelled")), l.dispose;
}
function Jt(e, t, l, n, o, a) {
  let i = et(), p = a !== void 0 ? qn(a) : () => {
  };
  return We(e, ...o), pt(e, ...t, ...l), i.nextFrame(() => {
    We(e, ...l), pt(e, ...n), i.add(Un(e, (c) => (We(e, ...n, ...t), pt(e, ...o), p(c))));
...
let Ao = de.RenderStrategy, _e = W({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: !0 }, appear: { type: [Boolean], default: !1 }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => !0, afterEnter: () => !0, beforeLeave: () => !0, afterLeave: () => !0 }, setup(e, { emit: t, attrs: l, slots: n, expose: o }) {
  ...
  let v = V(null), d = V("visible"), g = S(() => e.unmount ? ke.Unmount : ke.Hidden);
  o({ el: v, $el: v });
  let { show: w, appear: k } = Zn(), { register: x, unregister: y } = Kn(), $ = { value: !0 }, _ = oe(), O = { value: !1 }, D = No(() => {
  ...
  U(() => {
    ...
    if (g.value === ke.Hidden && _) {
      if (w && d.value !== "visible") {
        d.value = "visible";
        return;
      }
      Q(d.value, { hidden: () => y(_), visible: () => x(_) });
    }
  });
  let I = Se(e.enter), L = Se(e.enterFrom), A = Se(e.enterTo), N = Se(e.entered), j = Se(e.leave), F = Se(e.leaveFrom), ee = Se(e.leaveTo);
  U(() => {
    ne(() => {
      if (d.value === "visible") {
        let fe = P(v);
  ...
  function ge(fe) {
    let H = $.value && !k.value, Z = P(v);
    !Z || !(Z instanceof HTMLElement) || H || (O.value = !0, w.value && i(), w.value || c(), fe(w.value ? Jt(Z, I, L, A, N, (le) => {
  ...
  }), ie(Nt, D), Qe(S(() => Q(d.value, { visible: Y.Open, hidden: Y.Closed }) | a.value)), () => {
    let { appear: fe, show: H, enter: Z, enterFrom: le, enterTo: pe, entered: qe, leave: Ce, leaveFrom: k1, leaveTo: $1, ...Ft } = e, Uo = { ref: v }, Wo = { ...Ft, ...k && w && Re.isServer ? { class: E([l.class, Ft.class, ...I, ...L]) } : {} };
    return G({ theirProps: Wo, ourProps: Uo, slot: {}, slots: n, attrs: l, features: Ao, visible: d.value === "visible", name: "TransitionChild" });
  };
} }), Qn = _e, ze = W({ inheritAttrs: !1, props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: !0 }, appear: { type: [Boolean], default: !1 }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => !0, afterEnter: () => !0, beforeLeave: () => !0, afterLeave: () => !0 }, setup(e, { emit: t, attrs: l, slots: n }) {
  let o = Be(), a = S(() => e.show === null && o !== null ? (o.value & Y.Open) === Y.Open : e.show);
  ne(() => {
    if (![!0, !1].includes(a.value))
      throw new Error('A <Transition /> is used but it is missing a `:show="true | false"` prop.');
  });
  let i = V(a.value ? "visible" : "hidden"), p = No(() => {
    i.value = "hidden";
  }), c = V(!0), f = { show: a, appear: S(() => e.appear || !c.value) };
  return U(() => {
    ne(() => {
    ...
    return G({ ourProps: { ...d, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [J(Qn, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...l, ...d, ...v }, n.default)] }, attrs: {}, features: Ao, visible: i.value === "visible", name: "Transition" });
  };
} });
const Yn = {
  key: 0,
  class: "po-text-sm po-font-normal po-text-slate-400 po-select-none po-block po-text-left po-pt-5"
}, Jn = { class: "po-grid po-grid-cols-3" }, Xn = { class: "po-bg-white hover:po-bg-slate-200 po-rounded-xl po-p-2 po-transition-colors po-duration-150 po-ease-in" }, ea = ["href", "target"], ta = { class: "po-flex po-w-14 po-h-14 po-items-center po-justify-center po-duration-100 po-ease-in-out po-overflow-hidden" }, oa = ["innerHTML"], la = { class: "po-text-slate-500 po-font-normal po-text-sm po-text-center" }, Xt = {
  __name: "appList",
  props: {
    /**
  ...
  setup(e) {
    return (t, l) => (r(!0), u(B, null, R(e.list, (n) => (r(), u("div", null, [
      n.groupName.length > 0 ? (r(), u("span", Yn, m(n.groupName), 1)) : b("", !0),
      s("ul", Jn, [
        (r(!0), u(B, null, R(n.apps, (o) => (r(), u("li", Xn, [
          s("a", {
            href: o.url,
  ...
  setup(e) {
    ...
    return (o, a) => e.justApps ? (r(), M(Xt, {
      key: 1,
      list: h(n),
      "open-in-new-tab": e.openInNewTab
    }, null, 8, ["list", "open-in-new-tab"])) : (r(), M(h(nt), { key: 0 }, {
      default: T(({ open: i }) => [
        C(h(Tt), {
        ...
        C($e, {
          ...
          default: T(() => [
            C(h(Bt), { class: "po-z-10 po-absolute po-right-0 po-top-[3.6rem] po-opacity-0 po-bg-white po-shadow-lg po-rounded-xl po-w-[366px] po-p-4 po-border po-border-slate-300 po-pt-5 po-transition-all po-duration-100 po-ease-linear po-max-h-[calc(100vh-85px)] po-overflow-y-auto po-text-center" }, {
              default: T(() => [
                C(Xt, {
                  list: h(n),
                  "open-in-new-tab": e.openInNewTab
  ...
  key: 0,
  class: "po-space-y-2"
}, ia = ["onClick"], ua = { class: "po-flex po-items-center po-justify-between" }, pa = { class: "po-text-sm po-text-left po-font-semibold po-text-slate-700 po-grow po-flex po-space-x-2 po-items-center" }, ca = { class: "po-grow" }, da = {
  key: 0,
  class: "po-w-[6px] po-h-[6px] po-rounded-full po-shrink-0 po-bg-mpao-orange po-animate-pulse"
}, fa = { class: "po-text-xs po-font-normal po-text-slate-400 po-shrink-0" }, va = { class: "po-block po-text-sm po-text-slate-500 po-pb-3 po-text-left" }, ma = {
  key: 1,
      ...
      default: T(({ open: o }) => [
        ...
        C($e, {
          ...
          default: T(() => [
            C(h(Bt), { class: "po-z-10 po-absolute po-right-0 po-top-[3.6rem] po-opacity-0 po-bg-white po-shadow-lg po-rounded-xl po-w-[366px] po-p-4 po-border po-border-slate-300 po-pt-5 po-transition-all po-duration-100 po-ease-linear po-max-h-[calc(100vh-85px)] po-overflow-y-auto po-text-center" }, {
              default: T(() => [
                e.notifications !== null && e.notifications.length > 0 ? (r(), u("ul", ra, [
                  (r(!0), u(B, null, R(e.notifications, (a) => (r(), u("li", {
                    ...
                    s("span", ua, [
                      s("p", pa, [
                        s("span", ca, m(a.name), 1),
                        a.seen ? b("", !0) : (r(), u("span", da))
                      ]),
                      s("span", fa, m(a.time), 1)
                    ]),
                    s("span", va, m(a.text), 1)
                  ], 8, ia))), 256))
                ])) : (r(), u("span", ma, " No notifications to show at the moment. We'll keep you informed."))
              ]),
              _: 1
            })
          ]),
...
}, xa = ["src"], wa = ["src", "alt"], Va = {
  key: 1,
  class: "po-text-xs po-text-white po-font-semibold"
}, ka = { class: "po-pb-5" }, $a = ["src"], _a = {
  key: 2,
  class: "po-block po-text-sm po-text-slate-400 po-italic"
}, Ca = { key: 0 }, Sa = { key: 1 }, Pa = /* @__PURE__ */ s("div", { class: "po-h-[1px] po-w-full po-bg-gradient-to-l po-from-orange-200 po-via-blue-300 po-to-blue-200" }, null, -1), Oa = { class: "po-space-y-2 po-py-2 po-max-h-[250px] po-overflow-y-auto" }, Ea = ["onClick"], La = { class: "po-w-5" }, Ta = { class: "" }, Ba = { class: "po-block po-text-sm po-font-normal" }, ja = {
  key: 0,
  class: "po-text-left po-block po-text-xs po-text-slate-400"
}, Da = /* @__PURE__ */ s("div", { class: "po-h-[2px] po-w-full po-bg-gradient-to-l po-from-orange-200 po-via-blue-300 po-to-blue-200" }, null, -1), Na = { class: "md:po-grid po-grid-cols-2 po-space-x-1 po-pt-2" }, Aa = { class: "po-w-5" }, Ma = /* @__PURE__ */ s("span", { class: "po-text-sm po-font-normal" }, "Profile", -1), Ia = { class: "po-w-5" }, Ra = /* @__PURE__ */ s("span", { class: "po-text-sm po-font-normal" }, "Logout", -1), Fa = /* @__PURE__ */ s("div", { class: "po-text-xs po-space-x-3 po-text-center po-pt-3" }, [
  /* @__PURE__ */ s("a", {
    href: "",
  ...
  setup(e, { emit: t }) {
    ...
    const i = S(() => {
      var x, y, $, _, O, D, I, L, A, N, j, F, ee;
      let d = [], g = (x = l.userObject) != null && x.transacting_as_organisation && Object.keys((y = l.userObject) == null ? void 0 : y.transacting_as_organisation).length > 0 ? ($ = l.userObject) == null ? void 0 : $.transacting_as_organisation : null, w = g ? g.name : (_ = l.userObject) == null ? void 0 : _.name, k = g ? g.logo ? g.logo : (O = l.userObject) == null ? void 0 : O.avatar : "";
      return o.value = {
        name: w,
        initials: a(w),
        image: k
      ...
      }), ((N = (A = l.userObject) == null ? void 0 : A.organisations) == null ? void 0 : N.length) > 0 && ((F = (j = l.userObject) == null ? void 0 : j.organisations) == null || F.forEach((ge) => d.push(ge))), d.forEach((ge) => {
        var fe, H, Z, le;
        ge.current = ((fe = l.userObject) == null ? void 0 : fe.transacting_as_organisation) && Object.keys((H = l.userObject) == null ? void 0 : H.transacting_as_organisation).length > 0 && ge.entity_id === ((le = (Z = l.userObject) == null ? void 0 : Z.transacting_as_organisation) == null ? void 0 : le.entity_id);
      }), ((ee = l.userObject) == null ? void 0 : ee.transacting_as_organisation) === null && (d[0].current = !0), d;
    }), p = V(null), c = V(null), { avatar: f, logo: v } = ye(l);
    return q(f, () => {
      p.value = f.value;
    }), q(v, () => {
      c.value = v.value;
      ...
      i.value;
    }), (d, g) => (r(), M(h(nt), { key: h(i) }, {
      default: T(({ open: w }) => [
        s("div", null, [
          C(h(Tt), { class: "po-flex po-items-center po-outline-none" }, {
            default: T(() => [
              c.value ? b("", !0) : (r(), u("span", ga, m(o.value.name), 1)),
              c.value ? (r(), u("span", ya, [
                s("img", {
                  class: "po-h-8",
                  src: c.value,
              ...
              s("div", {
                ...
                s("div", {
                  ...
                  p.value ? (r(), u("img", {
                    ...
                    src: p.value,
                    alt: o.value.name
                  }, null, 8, wa)) : (r(), u("span", Va, m(o.value.initials), 1))
                ], 2)
              ], 2)
            ]),
            _: 2
                ...
                default: T(() => {
                  ...
                  return [
                    s("div", ka, [
                      ...
                      (k = e.userObject) != null && k.name ? (r(), u("span", {
                        key: 1,
                        class: E(["po-text-base po-text-slate-600 po-font-medium po-block", [{ "po-mt-4": p.value }]])
                      }, m((x = e.userObject) == null ? void 0 : x.name), 3)) : b("", !0),
                      (y = e.userObject) != null && y.name ? (r(), u("span", _a, [
                        o.value.name === (($ = e.userObject) == null ? void 0 : $.name) ? (r(), u("span", Ca, "Self")) : (r(), u("span", Sa, "User at " + m(o.value.name), 1))
                      ])) : b("", !0)
                    ]),
                    Pa,
                    s("div", Oa, [
                      (r(!0), u(B, null, R(h(i), (_, O) => (r(), u("a", {
                        href: "#",
                        ...
                        s("span", Ta, [
                          s("span", Ba, m(_.name), 1),
                          _.identifier ? (r(), u("span", ja, m(_.identifier), 1)) : b("", !0)
                        ])
                      ], 10, Ea))), 128))
                    ]),
                    Da,
                    s("div", Na, [
                      s("a", {
                        href: "#",
                        onClick: g[0] || (g[0] = re((_) => d.$emit("button-click", "current-profile"), ["prevent"])),
                        class: "po-flex po-items-center po-space-x-3 po-p-3 po-text-slate-600 po-rounded-lg po-bg-slate-50 hover:po-bg-blue-50 po-transition-all po-duration-150 po-ease-out",
                        role: "button"
                      }, [
                        s("span", Aa, [
                          C(h(Ht), { class: "po-stroke-current" })
                        ]),
                        Ma
                      ]),
                      s("a", {
                        href: "#",
                        onClick: g[1] || (g[1] = re((_) => d.$emit("button-click", "logout"), ["prevent"])),
                        class: "po-flex po-items-center po-space-x-3 po-p-3 po-text-slate-600 po-rounded-lg po-bg-slate-50 hover:po-bg-blue-50 po-transition-all po-duration-150 po-ease-out",
                        role: "button"
                      }, [
                        s("span", Ia, [
                          C(h(ll), { class: "po-stroke-current" })
                        ]),
                        Ra
                      ])
                    ]),
...
}, qa = ["disabled", "aria-disabled"], Ua = ["value", "disabled", "aria-disabled"], Wa = {
  name: "PoButton"
}, Mt = /* @__PURE__ */ Object.assign(Wa, {
  props: {
    /**
  ...
  setup(e, { emit: t }) {
    ...
    return (i, p) => (r(), u(B, null, [
      e.isLoading ? (r(), u("span", {
        key: 0,
        class: E([[n, h(o)], "po-bg-slate-200 hover:po-bg-slate-200 focus:po-bg-slate-200"])
      }, [
        C(At, {
...
const Ya = {
  ...
  setup(e, { emit: t }) {
    ...
    const { errorMessage: p } = ye(l), c = V(p.value !== null);
    return q(p, (f, v) => {
      ...
      default: T(() => [
        C(h(sn), { class: "po-text-sm po-font-medium po-flex po-items-center po-space-x-1 po-text-slate-700" }, {
          default: T(() => [
            s("span", null, m(e.label), 1),
            e.required ? (r(), u("span", Ya, "*")) : b("", !0),
            e.info !== null ? (r(), u("abbr", {
              key: 1,
              title: e.info,
              class: "po-w-4 po-text-slate-500"
            }, [
              C(h(It), { class: "po-fill-current" })
            ], 8, Ja)) : b("", !0)
          ]),
          _: 1
        }),
        s("div", Xa, [
          ...
          h(a).length > 0 ? (r(), M(h(pn), {
            key: 0,
            class: "po-absolute po-z-10 po-mt-1 po-max-h-60 po-w-full po-overflow-auto po-rounded-md po-bg-white po-py-1 po-text-base po-shadow-lg po-ring-1 po-ring-black po-ring-opacity-5 focus:po-outline-none sm:po-text-sm"
          }, {
            default: T(() => [
              (r(!0), u(B, null, R(h(a), (d) => (r(), M(h(cn), {
                key: d.id,
                value: e.object ? d : d.id,
                as: "template"
              }, {
                default: T(({ active: g, selected: w }) => [
                  s("li", {
                    class: E([
                    ...
                    s("span", {
                      ...
                      X(m(d.name) + " ", 1),
                      d.subtitle ? (r(), u("span", ts, m(d.subtitle), 1)) : b("", !0)
                    ], 2),
                    w ? (r(), u("span", {
                      key: 0,
                      class: E([
        ...
        e.message !== null ? (r(), u("p", os, m(e.message), 1)) : b("", !0),
        h(p) !== null ? (r(), u("p", ls, [
          s("span", null, m(h(p)), 1)
        ])) : b("", !0)
      ]),
  ...
  setup(e, { emit: t }) {
    ...
    return (i, p) => (r(), u("div", null, [
      e.openBtnLabel.length > 0 ? (r(), M(h(Mt), {
        key: 0,
                            ...
                            s("div", ps, [
                              ...
                              s("div", ds, [
                                s("span", {
                                  ...
                                  C(h(Ke), { class: "po-w-5 po-stroke-slate-500 hover:po-stroke-mpao-orange po-transition-colors po-duration-150 po-ease-in-out" })
                                ])
                              ])
                            ]),
                            fs,
...
const ws = ["for"], Vs = {
  key: 0,
  class: "po-text-lg po-leading-[0] po-text-red-400 po-font-semibold"
}, ks = ["title"], $s = ["name", "id", "value", "placeholder", "disabled", "required", "aria-describedby", "aria-required", "aria-disabled"], _s = ["id"], Cs = ["id"], Ss = {
  name: "PoTextarea"
  ...
  setup(e) {
    return (t, l) => (r(), u("div", {
      ...
      e.message !== null ? (r(), u("p", {
        ...
        class: "po-mt-2 po-text-sm po-text-slate-500",
        id: `${e.id}-description`
      }, m(e.message), 9, _s)) : b("", !0),
      e.errorMessage !== null ? (r(), u("p", {
        key: 1,
        class: "po-mt-2 po-text-sm po-text-red-600",
        id: `${e.id}-error`
      }, m(e.errorMessage), 9, Cs)) : b("", !0)
    ], 2));
  }
}), Os = { class: "shell-sidebar--icon" }, Es = /* @__PURE__ */ s("span", { class: "shell-sidebar--label po-font-medium" }, "Feedback", -1), Ls = { action: "" }, Ts = /* @__PURE__ */ s("br", null, null, -1), Bs = { class: "po-p-5" }, js = {
  __name: "feedbackForm",
  setup(e) {
    const t = V(!1), l = [
      {
    ...
    return (o, a) => (r(), u(B, null, [
      s("button", {
        ...
        s("span", Os, [
          C(h(ul), { class: "po-stroke-current po-w-5 po-h-5 po-stroke-2" })
        ]),
        Es
      ]),
      C(He, {
      ...
      s("aside", Ds, [
        s("div", Ns, [
          (r(!0), u(B, null, R(e.content, (f) => (r(), u("div", null, [
            C(h(Zt), { defaultOpen: !0 }, {
              default: T(({ open: v }) => [
                f.groupName ? (r(), M(h(Kt), {
                  key: 0,
                ...
                C($e, {
                  ...
                  default: T(() => [
                    C(h(Qt), null, {
                      default: T(() => [
                        s("ul", As, [
                          (r(!0), u(B, null, R(f.items, (d) => (r(), u("li", null, [
                            d.disabled ? b("", !0) : (r(), u("button", {
                              key: 0,
                              onClick: (g) => i("button-click", d.url),
                              class: E([
                                "shell-sidebar--item",
                                { active: d.url == e.currRoute }
                              ]),
                              title: `Go to ${d.label}`
                            }, [
                              s("span", Is, [
                                (r(), M(be(d.icon), { class: "po-stroke-current po-w-5 po-h-5 po-stroke-2" }))
                              ]),
                              s("span", Rs, m(d.label), 1)
                            ], 10, Ms))
                          ]))), 256))
                        ])
                      ]),
          ...
          h(n).length > 0 ? (r(), u("div", Fs, [
            C(h(Zt), { defaultOpen: !0 }, {
              default: T(({ open: f }) => [
                e.appsLabel ? (r(), M(h(Kt), {
                  key: 0,
                ...
                C($e, {
                  ...
                  default: T(() => [
                    C(h(Qt), null, {
                      default: T(() => [
                        s("ul", zs, [
                          (r(!0), u(B, null, R(h(n), (v, d) => (r(), u("li", null, [
                            s("button", {
                              onClick: (g) => i("app-click", v.name),
    ...
    return (t, l) => e.items !== null && e.items.length > 0 || e.showBackButton ? (r(), u("section", Ks, [
      s("nav", Qs, [
        (r(!0), u(B, null, R(e.items, (n) => (r(), u("span", {
          ...
          (r(), M(be(n.icon), { class: "po-stroke-current po-w-5 po-h-5 po-stroke-2" })),
      ...
      e.showBackButton ? (r(), u("nav", Xs, [
        s("span", {
          ...
          er,
          (r(), M(be(h(nl)), { class: "po-stroke-current po-w-5 po-h-5 po-stroke-2" }))
        ])
      ])) : b("", !0)
    ])) : b("", !0);
  }
  ...
  setup(e) {
    return (t, l) => (r(), u("div", or, [
      ...
      s("div", {
        ...
        e.title.length > 0 ? (r(), u("h3", nr, m(e.title), 1)) : b("", !0),
  ...
  setup(e, { emit: t }) {
    return (l, n) => (r(), u("div", rr, [
      s("form", ir, [
        ...
        s("div", pr, [
          s("div", cr, [
            C(h(Vt), { class: "po-h-5 po-w-5 po-flex-shrink-0" })
          ]),
          s("input", {
            name: "search-field",
  ...
  setup(e, { emit: t }) {
    ...
    return (i, p) => (r(), u("div", mr, [
      ...
      s("button", {
        ...
        C(h(dl), { class: "po-w-4 po-stroke-current po-stroke-2" })
      ]),
      s("button", {
        title: "Next",
        onClick: o,
        ...
        C(h(fl), { class: "po-w-4 po-stroke-current po-stroke-2" })
      ])
    ]));
  }
}), yr = { key: 0 }, xr = {
...
}, Cr = { class: "po-flex po-items-end po-justify-end po-flex-col" }, Sr = {
  key: 0,
  class: "po-flex md:po-justify-end po-mb-5"
}, Pr = { class: "po-bg-slate-50 po-shadow-sm po-rounded-xl po-py-5 po-px-2 po-divide-x po-divide-slate-200 po-flex" }, Or = ["onClick"], Er = { class: "po-text-xl po-font-medium po-text-slate-600 po-flex po-items-center po-space-x-1" }, Lr = { class: "po-text-xl po-font-medium po-text-slate-600 group-hover:po-text-mpao-lightblue" }, Tr = { class: "po-text-sm po-text-slate-500 po-block group-hover:po-text-mpao-lightblue" }, Br = { class: "po-flex po-items-center po-space-x-1 md:po-justify-end" }, jr = {
  key: 2,
  ...
  setup(e, { emit: t }) {
    ...
    return (i, p) => e.standAlone ? (r(), u("div", yr, [
      s("h1", xr, m(e.label), 1),
      e.description !== "" ? (r(), u("span", wr, m(e.description), 1)) : b("", !0)
    ])) : (r(), u("div", Vr, [
      s("div", kr, [
        s("div", null, [
          s("h1", $r, m(e.label), 1),
          e.description !== "" ? (r(), u("span", _r, m(e.description), 1)) : b("", !0)
        ]),
        s("div", Cr, [
          ...
          s("div", Br, [
            e.showFilter ? (r(), u("button", {
              ...
              title: "Filter",
              onClick: p[0] || (p[0] = (c) => {
                i.$emit("button-click", "filter"), n.value = !h(n);
              }),
              class: E([
              ...
              C(h(ml), { class: "po-w-4 po-stroke-current po-stroke-2" })
            ], 2)) : b("", !0),
            e.showDownload ? (r(), u("button", {
              ...
              C(h(ol), { class: "po-w-4 po-stroke-current po-stroke-2" })
            ])) : b("", !0),
            e.showFilter && e.showPagination || e.showDownload && e.showPagination ? (r(), u("span", jr, " ")) : b("", !0),
            e.showPagination ? (r(), M(gr, {
              key: 3,
  ...
  name: "PoTable",
  components: { ArrowRightCircleIcon: Io }
}, j1 = /* @__PURE__ */ Object.assign(Zr, {
  props: {
    /**
  ...
  setup(e) {
    const t = e, { isLoading: l, tbody: n } = ye(t), o = V(!1), a = V(null);
    q(l, () => {
      i();
    }), q(n, () => {
      i(), p();
    ...
    return (f, v) => (r(), u("table", {
      class: E(["table-responsive po-w-full", [{ lg: e.breakAtLg }]])
    }, [
      s("thead", null, [
        s("tr", null, [
          e.hasDetailsRow ? (r(), u("th", Mr)) : b("", !0),
          (r(!0), u(B, null, R(e.thead, (d) => (r(), u("th", null, [
            te(f.$slots, "th", Me(Ie(d)))
          ]))), 256))
        ])
      ]),
      s("tbody", null, [
        a.value !== null && !o.value || a.value !== null && a.value.length !== 0 && !o.value ? (r(!0), u(B, { key: 0 }, R(a.value, (d, g) => (r(), u(B, null, [
          s("tr", null, [
            e.hasDetailsRow ? (r(), u("td", Ir, [
              s("span", {
                onClick: (w) => d.showDetails = !d.showDetails
              }, [
                C(h(Io), {
        ...
        o.value ? (r(!0), u(B, { key: 2 }, R(a.value, (d) => (r(), u("tr", null, [
          (r(!0), u(B, null, R(e.thead, (g) => (r(), u("td", Ur, [
            s("div", Wr, [
              s("div", {
  ...
  name: "PoDynamicTable",
  components: { ArrowsUpDownIcon: Fo, ArrowUpIcon: Ro, ArrowDownIcon: Mo }
  ...
  setup(e) {
    const t = e, l = V(t.columns), n = V(null), o = V(null), a = (c) => {
    ...
    return ne(() => {
      ...
      (r(!0), u(B, null, R(l.value, (v) => (r(), u("div", null, [
        Ge(s("input", {
          type: "checkbox",
          name: "dynamic",
      ...
      s("table", Yr, [
        s("thead", null, [
          s("tr", null, [
            (r(!0), u(B, null, R(l.value, (v) => (r(), u("th", {
              key: v.key,
              onClick: (d) => i(v)
            }, [
              X(m(v.label) + " " + m(v.sorted) + " " + m(v.sortDirection) + " ", 1),
              v.sortable ? (r(), u("span", Xr, [
                v.sorted ? b("", !0) : (r(), M(h(Fo), {
                  key: 0,
                  class: "po-w-4"
                })),
                v.sorted && v.sortDirection === "asc" ? (r(), M(h(Ro), {
                  key: 1,
                  class: "po-w-4"
                })) : b("", !0),
                v.sorted && v.sortDirection === "desc" ? (r(), M(h(Mo), {
                  key: 2,
                  class: "po-w-4"
                })) : b("", !0)
              ])) : b("", !0),
              v.hidable ? (r(), u("button", {
                key: 1,
                onClick: (d) => a(v)
              }, m(v.hidden ? "Show" : "Hide"), 9, ei)) : b("", !0)
            ], 8, Jr))), 128))
          ])
        ]),
        s("tbody", null, [
          (r(!0), u(B, null, R(p.value, (v) => (r(), u("tr", {
            key: v.id
          }, [
            (r(!0), u(B, null, R(l.value, (d) => (r(), u("td", {
              key: d.key
            }, m(v[d.key]), 1))), 128))
          ]))), 128))
        ])
  ...
  setup(e, { emit: t }) {
    ...
    const { errorMessage: o } = ye(l), a = V(o.value !== null);
    q(o, (d, g) => {
    ...
    const p = V(null), c = (d) => {
      ...
      p.value = g;
      let w = l.type === "currency" ? v(g) : g;
      t("update:modelValue", w);
    };
    q(l, (d, g) => {
      l.type === "currency" && p.value !== g.modelValue ? p.value = zt(l.modelValue) : p.value = l.modelValue;
    });
    const f = (d) => {
      let g = null;
      l.type === "currency" ? g = zt(v("" + d)) : g = d, p.value = g;
    }, v = (d) => {
      let g = d.replace(/,/g, "");
      const w = g.indexOf(".");
      return w !== -1 && g.substring(w + 1) === "00" && (g = g.substring(0, w)), g;
    };
    return l.type === "currency" ? f(l.modelValue) : p.value = l.modelValue, (d, g) => (r(), u("div", {
      class: E(["po-relative", [{ "lg:po-grid lg:po-grid-cols-2": e.display === "horizontal" }]])
    }, [
      s("label", {
        for: e.id,
      ...
      s("input", Ee({
        ...
        onInput: c,
        onBlur: g[0] || (g[0] = (w) => f(w.target.value)),
        class: [
      ...
      e.message !== null ? (r(), u("p", {
        ...
        class: "po-mt-2 po-text-sm po-text-slate-500",
        id: `${e.id}-description`
      }, m(e.message), 9, di)) : b("", !0),
      a.value && h(o) !== null ? (r(), u("p", {
        key: 1,
        class: "po-mt-2 po-text-sm po-text-red-600 po-flex po-items-start po-space-x-1",
        id: `${e.id}-error`
      }, [
...
}, ki = ["aria-valuenow"], $i = ["id"], _i = ["id"], Ci = {
  name: "PoInputFile"
}, A1 = /* @__PURE__ */ Object.assign(Ci, {
  props: {
    /**
     * Model value
     */
  ...
  setup(e) {
    const t = e, l = S(() => `width: ${t.progress}%`), n = S(() => t.progress), o = V(""), a = (i) => {
    ...
    return (i, p) => (r(), u("div", {
      ...
      s("label", {
        ...
        s("div", yi, [
          C(h(oo), { class: "po-w-4 po-stroke-slate-500" }),
    ...
    return (t, l) => (r(), u("ul", Ei, [
      (r(!0), u(B, null, R(e.menuItems, (n) => (r(), u("li", null, [
        s("span", {
          ...
          (r(), M(be(n.icon), { class: "po-w-4 po-h-4 po-stroke-current" })),
          s("span", null, m(n.label), 1)
        ], 10, Li)
      ]))), 256))
    ]));
  }
}), Bi = { class: "po-relative po-flex po-items-start" }, ji = { class: "po-flex po-h-5 po-items-center" }, Di = ["name", "id", "checked", "disabled", "aria-describedby"], Ni = { class: "po-ml-3 po-text-sm" }, Ai = ["for"], Mi = {
  key: 0,
  class: "po-text-lg po-leading-[0] po-text-red-400 po-font-semibold"
}, Ii = ["id"], Ri = { class: "po-sr-only" }, Fi = ["id"], zi = {
  name: "PoCheckbox"
}, R1 = /* @__PURE__ */ Object.assign(zi, {
  props: {
    /**
     * Model value
     */
              ...
              (r(!0), u(B, null, R(e.changelog, (a, i) => (r(), u("div", null, [
                l.value === i ? (r(), u("div", Ki, [
                  s("div", Qi, [
                    ...
                    a.hasMore ? (r(), u("span", ou, "More")) : b("", !0)
                  ])
                ])) : b("", !0)
              ]))), 256))
            ])
...
const cu = /* @__PURE__ */ st(iu, [["render", pu]]), du = { class: "-po-m-5" }, fu = ["src", "alt"], eo = {
...
], -1), wu = { class: "po-mt-5 sm:po-mt-0" }, Vu = /* @__PURE__ */ s("p", { class: "-po-mt-1 po-text-xs po-text-slate-500" }, " 8th Floor, Allied Building , Chaandhanee Magu, Malé, 20156, Maldives ", -1), ku = { class: "po-mt-1 po-text-xs po-text-slate-500" }, $u = { class: "po-mt-1 po-text-xs po-text-slate-500 po-flex -po-mb-2 po-flex-wrap" }, _u = {
  href: "https://www.pension.gov.mv",
  target: "_blank",
  class: "po-flex po-space-x-1 po-items-center hover:po-text-mpao-lightblue po-mr-4 po-mb-2"
}, Cu = /* @__PURE__ */ s("span", null, "www.pension.gov.mv", -1), Su = {
  ...
  target: "_blank",
  class: "po-flex po-space-x-1 po-items-center hover:po-text-mpao-lightblue po-mr-4 po-mb-2"
}, Eu = /* @__PURE__ */ s("span", null, "1441", -1), Lu = { class: "po-flex lg:po-items-end po-flex-col" }, Tu = { class: "-po-mt-1 po-text-xs po-text-slate-500 po-flex -po-mb-2 po-flex-wrap" }, Bu = { class: "po-flex po-space-x-2 po-mt-3 lg:po-justify-end" }, ju = {
  name: "PoFooter"
}, F1 = /* @__PURE__ */ Object.assign(ju, {
  props: {
    /**
     * Chnagelog
     */
      ...
      s("section", gu, [
        s("div", yu, [
          ...
          s("div", wu, [
            ...
            s("p", $u, [
              s("a", _u, [
                C(h(ys), { class: "po-w-3 po-h-3 po-fill-current" }),
                Cu
              ]),
              s("a", Su, [
                C(h(bs), { class: "po-w-3 po-h-3 po-fill-current" }),
                Pu
              ]),
              s("a", Ou, [
                C(h(xs), { class: "po-w-3 po-h-3 po-fill-current" }),
                Eu
              ])
            ])
          ])
...
}), Du = { class: "po-text-sm po-text-red-700" }, Nu = {
  key: 0,
  ...
  setup(e) {
    return (t, l) => e.isError ? (r(), u("div", {
      ...
      C(h(dt), { class: "po-w-6 po-stroke-red-600" }),
      s("div", null, [
        s("span", Du, m(e.message), 1),
        e.errorList !== null ? (r(), u("ul", Nu, [
          (r(!0), u(B, null, R(e.errorList, (n) => (r(), u("li", null, m(n), 1))), 256))
        ])) : b("", !0)
      ])
    ], 2)) : (r(), u("div", Au, [
      C(h(pl), { class: "po-w-6 po-stroke-green-600" }),
      s("div", null, [
  ...
  setup(e, { emit: t }) {
    ...
    return q(o, (i, p) => {
      ...
      default: T(() => [
        C(h(Yt), { class: "po-text-sm po-font-medium po-flex po-items-center po-space-x-1 po-text-slate-700" }, {
          default: T(() => [
            s("span", null, m(e.label), 1),
            e.required ? (r(), u("span", Ru, "*")) : b("", !0)
          ]),
          _: 1
        }),
        e.options !== null ? (r(), u("div", Fu, [
          (r(!0), u(B, null, R(e.options, (c) => (r(), M(h(In), {
            as: "template",
            key: c.id,
            value: c.id
          }, {
        ...
        s("div", null, [
          e.message !== null ? (r(), u("p", {
            ...
            class: "po-mt-2 po-text-sm po-text-slate-500",
            id: `${i.id}-description`
          }, m(e.message), 9, qu)) : b("", !0),
          a.value && h(o) !== null ? (r(), u("p", {
            key: 1,
            class: "po-mt-2 po-text-sm po-text-red-600 po-flex po-items-start po-space-x-1",
            id: `${i.id}-error`
          }, [
            C(h(Ho), { class: "po-fill-current po-w-4 po-mt-[0.2rem] po-shrink-0" }),
            s("span", null, m(h(o)), 1)
          ], 8, Uu)) : b("", !0)
        ])
      ]),
          ...
          s("div", Ku, [
            s("div", null, [
              s("span", {
                ...
                (r(), M(be(n.icon), { class: "po-w-4 po-h-4" }))
              ], 2)
            ]),
            s("div", null, [
              s("div", Qu, [
                s("span", Yu, m(n.value), 1),
                n.diff ? (r(), u("span", Ju, m(n.diff), 1)) : b("", !0)
              ]),
              s("h4", Xu, m(n.label), 1)
            ])
          ])
      ...
      e.item.type !== "message" ? (r(), u("div", tp, [
        ...
        s("div", {
          ...
          s("span", op, [
            ...
            }, m(e.item.time_human), 9, lp)) : b("", !0),
            s("span", np, m(e.item.name), 1),
            e.item.type === "second" ? (r(), u("time", {
              key: 1,
              datetime: e.item.time,
              class: "po-text-xs po-text-slate-400"
            }, m(e.item.time_human), 9, ap)) : b("", !0)
          ]),
          s("div", {
            class: E([
...
}), _p = /* @__PURE__ */ s("div", { class: "po-fixed po-inset-0" }, null, -1), Cp = { class: "po-absolute po-inset-0 po-overflow-hidden" }, Sp = { class: "po-pointer-events-none po-fixed po-inset-y-0 po-right-0 po-flex po-max-w-full po-pl-10" }, Pp = { class: "po-flex po-h-full po-flex-col po-overflow-y-auto po-bg-white po-shadow-xl" }, Op = { class: "po-bg-slate-50 po-py-6 po-px-4 sm:po-px-6" }, Ep = { class: "po-flex po-items-center po-justify-between" }, Lp = { class: "po-ml-3 po-flex po-h-7 po-items-center" }, Tp = /* @__PURE__ */ s("span", { class: "po-sr-only" }, "Close panel", -1), Bp = {
  key: 0,
  class: "po-mt-1"
}, jp = { class: "po-text-sm po-text-slate-500" }, Dp = {
  key: 0,
  class: "po-bg-slate-50 po-rounded-b-xl po-shrink-0"
}, Np = {
  name: "PoSlideover"
}, G1 = /* @__PURE__ */ Object.assign(Np, {
  props: {
    /**
                      ...
                      C(h(ot), {
                        ...
                        default: T(() => [
                          s("div", Pp, [
                            s("div", Op, [
                              s("div", Ep, [
                                C(h(ko), { class: "po-text-lg po-font-medium po-text-slate-600" }, {
                                  default: T(() => [
                                    X(m(e.label), 1)
                                  ]),
                                  _: 1
  ...
  setup(e) {
    const t = e, l = V(""), { show: n } = ye(t), o = V(!1);
    q(n, () => {
      o.value = !1, setTimeout(() => {
        o.value = !0;
      }, 100);
          ...
          default: T(() => [
            ...
            s("div", Mp, [
              C(h(_e), {
                ...
                default: T(() => [
                  C(h(ot), { class: "po-mx-auto po-max-w-xl po-transform po-divide-y po-divide-gray-100 po-overflow-hidden po-rounded-xl po-bg-white po-shadow-2xl po-ring-1 po-ring-black po-ring-opacity-5 po-transition-all" }, {
                    default: T(() => [
                      s("div", Ip, [
                        C(h(Ka), {
            ...
            s("div", Hp, [
              s("div", qp, [
                C(h(_e), {
                  ...
                  default: T(() => [
                    C(h(ot), { class: "po-relative po-transform po-overflow-hidden po-rounded-lg po-bg-white po-text-left po-shadow-xl po-transition-all sm:po-my-8 sm:po-w-full sm:po-max-w-sm" }, {
                      default: T(() => [
                        s("div", Up, [
                          s("div", Wp, [
                            e.alertTitle !== "" ? (r(), M(h(ko), {
                              key: 0,
                              as: "h3",
          ...
          (r(!0), u(B, null, R(e.items, (n, o) => (r(), u("div", ec, [
            ...
            s("div", tc, [
              s("span", null, [
                ...
                n.by && n.by !== "" ? (r(), u("span", oc, m(n.by), 1)) : b("", !0)
              ]),
              n.description && n.description !== "" ? (r(), u("blockquote", lc, ' "' + m(n.description) + '" ', 1)) : b("", !0)
            ])
          ]))), 256))
        ])
      ])) : (r(), u("div", nc, [
...
const $c = /* @__PURE__ */ st(xc, [["render", kc]]), _c = {
  ...
  setup(e) {
    return (t, l) => e.show ? (r(), u("div", _c, [
      Cc,
      s("div", Sc, [
        e.label !== "" ? (r(), u("span", Pc, m(e.label), 1)) : b("", !0),
        C($c)
      ])
    ])) : b("", !0);
  }
}), Ec = { class: "po-py-5 po-flex po-items-start po-space-x-5" }, Lc = ["name", "id", "checked", "aria-describedby"], Tc = { class: "po-grow -po-mt-[0.26rem]" }, Bc = ["for"], jc = { class: "po-mt-2 po-flex po-space-x-3" }, Dc = ["href", "onClick"], Nc = {
  name: "PoConsent"
}, e0 = /* @__PURE__ */ Object.assign(Nc, {
  props: {
    /**
     * Model value
     */
  ...
  setup(e, { emit: t }) {
    ...
    return (n, o) => (r(), u("nav", Ac, [
      (r(!0), u(B, null, R(e.tabs, (a) => (r(), u("span", {
        ...
        a.icon ? (r(), M(be(a.icon), {
          key: 0,
          class: E(["po-w-5 po-h-5", [l(a)]])
        }, null, 8, ["class"])) : b("", !0),
        s("span", null, [
          X(m(a.name), 1),
          a.count ? (r(), u("span", Ic, " (" + m(a.count) + ")", 1)) : b("", !0)
        ])
      ], 10, Mc))), 128))
    ]));
  }
  ...
  setup(e) {
    return (t, l) => (r(), u("div", Zc, [
      s("div", {
        ...
        e.icon ? (r(), M(be(e.icon), {
          key: 0,
          class: E(["po-w-10 po-h-10", e.iconColor])
        }, null, 8, ["class"])) : b("", !0),
        e.label !== "" ? (r(), u("span", Kc, m(e.label), 1)) : b("", !0),
        e.description !== "" ? (r(), u("span", Qc, m(e.description), 1)) : b("", !0)
      ], 2),
      te(t.$slots, "action")
    ]));
  }
...
const od = { class: "po-flex po-text-sm po-text-gray-700 po-flex-col po-space-y-5" }, ld = {
  ...
  setup(e, { emit: t }) {
    ...
    return (n, o) => (r(), u("span", od, [
      e.record !== null ? (r(), u("h2", ld, " Death was reported by " + m(e.record.institution), 1)) : b("", !0),
      e.request !== null && e.request.type_id === 1 ? (r(), u("div", nd, [
        C(h(dt), { class: "po-shrink-0 po-w-6 po-stroke-orange-600" }),
      ...
      e.request !== null && e.request.type_id !== 1 ? (r(), u("div", sd, [
        C(h(dt), { class: "po-shrink-0 po-w-6 po-h-6 po-stroke-red-600 po-stroke-2" }),
        s("div", rd, [
          ...
          s("p", ud, [
            ...
            s("span", pd, [
              ...
              e.request.date_of_death ? (r(), u("span", cd, " (New date: " + m(e.request.date_of_death) + ")", 1)) : b("", !0)
            ])
          ])
        ])
      ])) : b("", !0),
      ...
      e.request === null ? (r(), u("span", xd, [
        C(Mt, {
          ...
          label: T(() => [
            s("span", wd, [
              C(h(rl), { class: "po-w-4 po-h-4 po-stroke-current" }),
              Vd
            ])
          ]),
          _: 1
  ...
  setup(e) {
    const t = e, l = V(), n = V();
    return t.btnType === "view" ? l.value = vl : t.btnType === "edit" ? l.value = hl : t.btnType === "delete" ? l.value = gl : t.btnType === "icon" && t.btnIcon && (l.value = t.btnIcon), t.btnType === "view" ? n.value = "po-stroke-emerald-400" : t.btnType === "edit" ? n.value = "po-stroke-blue-400" : t.btnType === "delete" ? n.value = "po-stroke-red-400" : n.value = t.iconColor, (o, a) => (r(), u("span", null, [
  ...
  setup(e) {
    ...
    return (l, n) => (r(), u("span", null, [
      e.amount !== null ? (r(), u("span", Cd, m(t(e.amount)), 1)) : b("", !0)
    ]));
  }
}), Pd = {
  name: "PoHeading"
}, r0 = /* @__PURE__ */ Object.assign(Pd, {
  props: {
    /**
     * Heading text
     */
  ...
  setup(e) {
    return (t, l) => (r(), M(be(e.type), { class: "po-text-base po-text-slate-600 po-font-semibold" }, {
      default: T(() => [
        X(m(e.text), 1)
      ]),
      _: 1
...
const Ed = ["for"], Ld = { class: "po-capitalize" }, Td = {
  key: 0,
  class: "po-text-lg po-leading-[0] po-text-red-400 po-font-semibold"
}, Bd = ["title"], jd = { class: "po-relative po-mt-1" }, Dd = {
  key: 0,
  ...
  setup(e, { emit: t }) {
    ...
    const o = V(""), a = V([]);
    function i(k) {
      a.value.splice(k, 1), f();
    }
    function p(k) {
      let x = o.value.split(",");
      k.key === "Enter" && 0 < o.value.length && (k.preventDefault(), x.forEach((y) => {
        let $ = l.items.find(
          (_) => _.name.toLowerCase() === y.trim().toLowerCase()
        );
        $ && a.value.push($);
      }), o.value = ""), k.key === "Backspace" && o.value.length === 0 && a.value.pop(), f();
    }
    const c = V([]);
    function f() {
      c.value = a.value.map((k) => k.id);
    }
    U(() => {
    ...
    return q(c, () => {
      ...
      s("label", {
        ...
        e.required ? (r(), u("span", Td, "*")) : b("", !0),
        e.info !== null ? (r(), u("abbr", {
          key: 1,
          title: e.info,
          class: "po-w-4 po-text-slate-500"
        }, [
          C(h(qo), { class: "po-fill-current" })
        ], 8, Bd)) : b("", !0)
      ], 10, Ed),
      s("div", jd, [
        s("div", {
          ...
          a.value.length > 0 ? (r(), u("div", Dd, [
            (r(!0), u(B, null, R(a.value, (y, $) => (r(), u("span", Nd, [
              s("span", null, m(y.name), 1),
              s("span", {
                onClick: () => i($),
                class: "po-rounded-full po-bg-white po-flex po-items-center po-justify-center po-w-4 po-h-4 po-cursor-pointer"
              }, [
                C(h(Rt), { class: "po-w-3 po-fill-mpao-lightblue" })
              ], 8, Ad)
            ]))), 256))
          ])) : b("", !0),
          Ge(s("input", {
      ...
      e.message !== null ? (r(), u("p", {
        ...
        class: "po-mt-2 po-text-sm po-text-slate-500",
        id: `${e.id}-description`
      }, m(e.message), 9, zd)) : b("", !0),
      e.hasError && e.errorMessage !== null ? (r(), u("p", {
        key: 1,
        class: "po-mt-2 po-text-sm po-text-red-600 po-flex po-items-center po-space-x-1",
        id: `${e.id}-error`
      }, [
        C(h(gs), { class: "po-fill-current po-w-4" }),
...
}, t1 = { class: "po-p-4" }, o1 = { class: "po-flex po-items-center po-space-x-3" }, l1 = /* @__PURE__ */ s("span", { class: "po-sr-only" }, "Action icon", -1), n1 = { class: "po-w-0 po-flex-1 po-text-sm po-font-medium po-text-gray-400" }, a1 = { class: "po-ml-4 po-flex po-flex-shrink-0" }, s1 = /* @__PURE__ */ s("span", { class: "po-sr-only" }, "Close", -1), r1 = {
  name: "PoToast"
}, c0 = /* @__PURE__ */ Object.assign(r1, {
  props: {
    /**
     * Pass model Open/Close to the component
     */
  ...
  setup(e, { emit: t }) {
    ...
    return (p, c) => (r(), M(Ze, { to: "#po-notifications-alert" }, [
      C($e, {
        "enter-active-class": "po-transform po-ease-out po-duration-300 po-transition",
        "enter-from-class": "po-translate-y-2 po-opacity-0 sm:po-translate-y-0 sm:po-translate-x-2",
        "enter-to-class": "po-translate-y-0 po-opacity-100 sm:po-translate-x-0",
            ...
            s("div", t1, [
              s("div", o1, [
                e.actionType !== "" ? (r(), u("div", {
                  ...
                  e.actionType === "success" ? (r(), M(h(zo), {
                    key: 0,
                    class: "po-w-5 po-h-5"
                  })) : b("", !0),
                  e.actionType === "danger" ? (r(), M(h(Qa), {
                    key: 1,
                    class: "po-w-5 po-h-5"
                  })) : b("", !0),
                  e.actionType === "warn" ? (r(), M(h(Ho), {
                    key: 2,
                    class: "po-w-5 po-h-5"
                  })) : b("", !0),
                  l1
  ...
  key: 0,
  class: "po-text-lg po-leading-[0] po-text-red-400 po-font-semibold"
}, p1 = ["title"], c1 = { class: "po-relative po-mt-1" }, d1 = {
  key: 1,
  ...
  setup(e, { emit: t }) {
    ...
    S(() => {
      if (l.value) {
        const d = document.querySelector(".shell-content--area"), { top: g } = d.getBoundingClientRect(), w = d.scrollTop, { top: k, left: x, width: y } = l.value.getBoundingClientRect();
        return { relativeTop: k - g + w, left: x, width: y };
      }
    });
    const o = V(null);
    V(null);
        ...
        s("div", null, [
          ...
          c.value !== null ? (r(), u("div", d1, [
            ...
            s("span", {
              ...
              C(h(Ke), { class: "po-w-4 po-stroke-2 po-stroke-slate-400" })
            ])
          ])) : b("", !0),
          Ge(s("input", {
            type: "text",
            ...
            onInput: p,
            onFocus: g[2] || (g[2] = (w) => n.value = !0),
            class: "po-w-full po-rounded-md po-border po-border-slate-300 po-bg-white po-py-2 po-pl-3 po-pr-10 focus:po-border-mpao-lightblue focus:po-outline-none focus:po-ring-0 sm:po-text-sm"
          }, null, 544), [
            [gt, i.value]
          ])
        ]),
        n.value && e.options.length > 0 || n.value && e.emptyMessage ? (r(), u("div", v1, [
          e.options && e.options.length > 0 ? (r(), u(B, { key: 0 }, [
            (r(!0), u(B, null, R(e.options, (w) => (r(), u("div", {
              onClick: (k) => f(w)
            }, [
              te(d.$slots, "option", Me(Ie(w)), () => [
                X(m(w), 1)
              ])
            ], 8, m1))), 256)),
            ...
            e.emptyMessage ? (r(), u("span", h1, m(e.emptyMessage), 1)) : b("", !0)
          ], 64))
        ])) : b("", !0),
        e.message !== null ? (r(), u("p", b1, m(e.message), 1)) : b("", !0),
...
export {
  ...
  U1 as PoChatLogItem,
  R1 as PoCheckbox,
  Z1 as PoCommandPalette,
  e0 as PoConsent,
  J1 as PoContentArea,
  n0 as PoDRStatus,
  si as PoDescriptionList,
  Y1 as PoDownloadFileList,
  D1 as PoDynamicTable,
  l0 as PoEmpty,
  F1 as PoFooter,
  z1 as PoFormStatusMessage,
  r0 as PoHeading,
  N1 as PoInputField,
  A1 as PoInputFile,
  X1 as PoLoading,
